...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){   
    Route::controller(WholesaleProductController::class)->group(function () {
        ...
        Route::get('/wholesale/inhouse-products', function () {
            return redirect(route('wholesale_products.store'), 301);
        });
        Route::get('/wholesale/store-products', 'in_house_wholesale_products')->name('wholesale_products.store');
