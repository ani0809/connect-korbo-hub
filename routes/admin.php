...
use App\Http\Controllers\CibatoUploadController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(AdminController::class)->group(function () {
        ...
        Route::post('/dashboard/store-top-brands', 'store_top_brands')->name('dashboard.store_top_brands');
        Route::post('/dashboard/store-top-categories', 'store_top_categories')->name('dashboard.store_top_categories');
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/products/create-v2', 'create_v2')->name('products.create.v2');
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        if (get_setting('system_font_family') == 1) {
    ...
    Route::group(['prefix' => 'website'], function () {
        Route::controller(WebsiteController::class)->group(function () {
            ...
            if (get_setting('homepage_select') == 1) {
                Route::get('/select-homepage', 'select_homepage')->name('website.select-homepage');
            }
            Route::get('/thecore-homepage-builder', 'thecore_homepage_builder')->name('website.thecore-homepage-builder');
            Route::post('/thecore-homepage-builder', 'save_thecore_homepage_builder')->name('website.thecore-homepage-builder.save');
            Route::post('/thecore-homepage-builder/reset', 'reset_thecore_homepage_builder')->name('website.thecore-homepage-builder.reset');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/inhouse-orders', function () {
            return redirect(route('store_orders.index'), 301);
        });
        Route::get('/inhouse-orders/{id}/show', function ($id) {
            return redirect(route('store_orders.show', $id), 301);
        })->where('id', '.*');
        Route::get('/store-orders', 'all_orders')->name('store_orders.index');
        ...
        Route::get('/store-orders/{id}/show', 'show')->name('store_orders.show');
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::get('/in_house_sale_report', function () {
            return redirect(route('store_product_sale_report.index'), 301);
        });
        Route::get('/store-product-sale-report', 'store_product_sale_report')->name('store_product_sale_report.index');
    ...
    // uploaded files
    Route::resource('/uploaded-files', CibatoUploadController::class);
    Route::controller(CibatoUploadController::class)->group(function () {
