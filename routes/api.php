...
Route::group(['prefix' => 'v2/auth', 'middleware' => ['app_language']], function () {
    ...
    Route::controller(AuthController::class)->middleware('throttle:api-auth')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'throttle:api-auth'])->group(function () {
        Route::controller(AuthController::class)->group(function () {
            // Preferred REST-safe routes
            Route::post('logout', 'logout');
            Route::delete('account-deletion', 'account_deletion');
            Route::post('resend_code', 'resendCode');

            // Backward-compatible legacy routes (keep for existing clients)
    ...
    Route::controller(PasswordResetController::class)->middleware('throttle:api-auth-reset')->group(function () {
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    //auth controller
    Route::post('guest-user-account-create', [AuthController::class, 'guestUserAccountCreate'])->middleware('throttle:api-auth');
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        Route::post('file/upload', 'App\Http\Controllers\Api\V2\CibatoUploadController@upload')->middleware('auth:sanctum');
    ...
    Route::get('products/store', 'App\Http\Controllers\Api\V2\ProductController@inhouse');
