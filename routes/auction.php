...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::controller(AuctionProductController::class)->group(function () {
        ...
        Route::get('auction/inhouse-products', function () {
            return redirect(route('auction.store_products'), 301);
        });
        Route::get('auction/store-products', 'inhouse_auction_products')->name('auction.store_products');
