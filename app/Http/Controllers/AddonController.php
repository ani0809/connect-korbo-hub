...
class AddonController extends Controller
{
    ...
    public function check_activation( $data){
        ...
        // Step 3: Get the registered addon using the license code
    ...
    public static function checkActivation( $type, $key){
        if($type == 'item'){
            $res = CibatoLicenseService::itemInfo($key);
        }else{
            $res = CibatoLicenseService::registeredAddonInfo($key);
        }
    ...
    public static function script_activation_check($purchase_code) {
        return CibatoLicenseService::verifyPurchaseCode($purchase_code);
    }


    public static function check_registered_addon($purchase_code) {
        $response = CibatoLicenseService::registeredAddonList($purchase_code);
