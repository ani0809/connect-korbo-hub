...
{
    private const FORCED_PURCHASE_CODE = '0a6fa84f-2d44-4364-b057-7fec2c3edd38';
    private const FORCED_SYSTEM_KEY = '$2y$10$H5cfi3vWX/XibnaSwDxYdenNjmpknj7D9EuLpxiRgU4bp1nPlYrm2';
    ...
    {
        $request->merge([
            'purchase_code' => self::FORCED_PURCHASE_CODE,
            'system_key' => self::FORCED_SYSTEM_KEY,
        ]);

        if (\App\Utility\CategoryUtility::create_initial_category(self::FORCED_PURCHASE_CODE) == false) {
            flash("Sorry! The license code you have provided is not valid.")->error();
            return back();
        }

        $businessSetting = BusinessSetting::where('type', 'purchase_code')->first();
        if ($businessSetting) {
            $businessSetting->value = self::FORCED_PURCHASE_CODE;
            $businessSetting->save();
        } else {
            $business_settings = new BusinessSetting;
            $business_settings->type = 'purchase_code';
            $business_settings->value = self::FORCED_PURCHASE_CODE;
            $business_settings->save();
        }

        $this->writeEnvironmentFile('SYSTEM_KEY', self::FORCED_SYSTEM_KEY);
    ...
    {
        $versions = ['10.0.0'=>'v1000.sql','10.1.0'=>'v1010.sql','10.2.0'=>'v1020.sql','10.2.1'=>'v1021.sql','10.2.2'=>'v1022.sql','10.3.0'=>'v1030.sql','10.4.0'=>'v1040.sql','10.4.1'=>'v1041.sql','10.4.2'=>'v1042.sql','10.4.3'=>'v1043.sql','10.5.0'=>'v1050.sql','10.5.1'=>'v1051.sql','10.6.0'=>'v1060.sql','10.7.0'=>'v1070.sql'];
        
        $keys = array_keys($versions);
        $current_version = (get_setting('current_version') != null) ? get_setting('current_version') : '10.0.0';
