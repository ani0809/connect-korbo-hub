...
class ReportController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['permission:in_house_product_sale_report'])->only('store_product_sale_report');
    ...
    public function store_product_sale_report(Request $request)
    {
        $sort_by = null;
        ...
        $products = $products->paginate(15);
        return view('backend.reports.store_product_sale_report', compact('products', 'sort_by'));
    }
