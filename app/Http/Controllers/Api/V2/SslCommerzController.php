...
class SslCommerzController extends Controller
{
    ...
    public function begin(Request $request)
    {
        ...
        if ($paymentType == "cart_payment") {
            ...
            $post_data['tran_id'] = 'CIBATO-' . $combinedOrderID. '-' . date('Ymd'); // tran_id must be unique
        }
        elseif ($paymentType == "order_re_payment") {
            ...
            $post_data['tran_id'] = 'CIBATO-' . $orderID . '-' . date('Ymd'); // tran_id must be unique
        }
        else if ($paymentType == "wallet_payment"){
            $post_data['value_b'] = 'sslcommerz';
            $post_data['tran_id'] = 'CIBATO-' . $user_id . '-' . date('Ymd');
        } 
