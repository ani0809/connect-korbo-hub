        ...
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <button type="button" class="btn d-lg-none mr-3 mr-sm-4 p-0 active" data-toggle="class-toggle"
                    data-target=".cibato-top-menu-sidebar">
                                        ...
                                        <div>
                                            @if (get_setting('show_compare_icon') == 'on' && \Route::has('compare'))
                                                <a href="{{ route('compare') }}"
                                                    class="dropdown-item fs-13 py-2 px-3 hover-bg-light hover-text-primary border-bottom border-soft-light d-flex align-items-center compare-visibility"
                                                    style="min-height: 40px;">
                                                    {{ translate('Compare') }}
        ...
        <div class="hover-user-top-menu position-absolute top-100 left-0 right-0 z-3">
            <div class="container">
                <div class="position-static float-right">
                    <div class="cibato-user-top-menu bg-white rounded-0 border-top shadow-sm" style="width:220px;">
