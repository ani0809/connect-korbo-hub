        ...
        <div class="p-0 position-relative">
            ...
            <div class="home-slider slider-full">
                @if (get_setting('home_slider_images', null, $lang) != null)
                    <div class="cibato-carousel dots-inside-bottom mobile-img-auto-height" data-autoplay="true" data-infinite="true" data-fade="true" data-autoplay-speed="3000">
                        @php
                ...
                @if (get_setting('vendor_system_activation') == 1)
                    ...
                    <section class="mt-2 mt-md-3 border h-100">
                        <div class="p-4">
                            ...
                            <!-- Sellers Section -->
                            <div class="cibato-carousel arrow-x-0 arrow-inactive-none" data-rows="2" data-items="3" data-xxl-items="3"
                ...
                @if (get_setting('top_brands') != null)
                    <section class="mt-2 mt-md-3 border h-100">
                        <div class="p-4">
                            ...
                            <!-- Brands Section -->
                            <div class="cibato-carousel arrow-x-0 arrow-inactive-none" data-rows="3" data-items="3" data-xxl-items="3"
