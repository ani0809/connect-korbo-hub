...
@if (get_setting('best_selling') == 1 && count($best_selling_products) > 0)
    <section class="mb-2 mb-md-3 mt-2 mt-md-3 border">
        <div class="container">
            ...
            <!-- Product Section -->
            <div class="px-sm-3">
                <div class="cibato-carousel sm-gutters-16 arrow-none" data-rows="2" data-items="3" data-xl-items="3" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
