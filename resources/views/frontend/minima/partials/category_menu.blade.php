<div class="cibato-category-menu bg-white rounded-0 border-top" id="category-sidebar" style="width:270px;">
    <ul class="list-unstyled categories no-scrollbar mb-0 text-left">
        @foreach (get_level_zero_categories()->take(12) as $key => $category)
            ...
            <li class="category-nav-element border border-top-0" data-id="{{ $category->id }}">
                ...
                <div class="sub-cat-menu more c-scrollbar-light border p-4 shadow-none"></div>
