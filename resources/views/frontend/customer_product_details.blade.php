        ...
        <div class="container d-flex flex-column">
            ...
            <section class="mb-4" id="relatedProduct">
                <div class="py-30px px-30px border  bg-white border-light-gray rounded-2">
                    ...
                    <div class="p-3">
                        <div class="cibato-carousel gutters-16 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4" data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                            @php
                            $products = get_similiar_classified_products($detailedProduct->category_id, $detailedProduct->id, 10);
                            @endphp
                            ...
                            <div class="carousel-box overflow-hidden has-transition hov-shadow-out z-1 border-right border-top border-bottom @if ($key == 0) border-left @endif">
                                <div class="cibato-card-box my-3">
...
<script type="text/javascript">
    function CopyToClipboard(e) {
        ...
        try {
            ...
            CIBATO.plugins.notify('success', '{{ translate('
                Link copied to clipboard ') }}');
        } catch (err) {
            CIBATO.plugins.notify('danger', '{{ translate('
                Oops, unable to copy ') }}');
        }
        $temp.remove();
    }
