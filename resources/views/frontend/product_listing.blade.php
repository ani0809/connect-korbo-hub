                    ...
                    <div class="col-xl-3">
                        <div class="cibato-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            <div class="overlay overlay-fixed dark c-pointer" data-toggle="class-toggle"
                                data-target=".cibato-filter-sidebar" data-same=".filter-sidebar-thumb"></div>
                            <div class="collapse-sidebar scroll-bar-show c-scrollbar-light text-left">
                                <div class="d-flex d-xl-none justify-content-between align-items-center pl-3 border-bottom">
                                    <h3 class="h6 mb-0 fw-600">{{ translate('Filters') }}</h3>
                                    <button type="button" class="btn btn-sm p-2 filter-sidebar-thumb"
                                        data-toggle="class-toggle" data-target=".cibato-filter-sidebar">
                                    ...
                                    @if ($attribute->product_count > 0)
                                        <div class="bg-white preorder-time-hide border-bottom-listing-sidebar">
                                            ...
                                            <div class="collapse {{ $show }}"
                                                ...
                                                <div class="px-3 cibato-checkbox-list">
                                                    @foreach ($attribute->attribute_values as $attribute_value)
                                                        @if ($attribute_value->product_count > 0)
                                                            <label class="cibato-checkbox mb-3 d-flex align-items-center ">
                                                                ...
                                                                <span class="cibato-square-check border_black"></span>
                                                                <span
                                        ...
                                        <div class="p-3 cibato-checkbox-list">
                                            <label class="cibato-checkbox mb-3">
                                                <input type="radio" name="is_available" value="1"
                                                    ...
                                                    onchange="filter(event)">
                                                <span class="cibato-square-check border_black"
                    ...
                    <div class="col-xl-9">
                        @if (addon_is_activated('preorder') && Route::currentRouteName() == 'search')
                            <div class="product-tab mt-2">
                                ...
                                @endphp
                                <div class="p-0 cibato-radio-inline">
                                    <label class="cibato-megabox pl-0 mr-2 " data-toggle="tooltip"
                                    ...
                                    <label class="cibato-megabox pl-0 " data-toggle="tooltip"
                            ...
                            <div class="row gutters-5 flex-wrap align-items-center">
                                ...
                                <div class="col-2 col-lg-auto d-xl-none mb-lg-3 text-right">
                                    <button type="button" class="btn btn-icon p-0" data-toggle="class-toggle"
                                        data-target=".cibato-filter-sidebar">
                                ...
                                <div class="col-6 col-lg-auto mb-3 w-lg-200px d-flex align-items-center gap-2">
                                    ...
                                    <select id="select_option"
                                        class="form-control select_btn_border_none form-control-sm text-center border-0 form-control-sm cibato-selectpicker rounded-0 "
                        ...
                        <div class="px-3">
                            ...
                            <div class="row gutters-16 row-cols-xxl-4 row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-2"
                                id="products-row">
                        ...
                        <div class="cibato-pagination mt-4" id="pagination"></div>
                    </div>
                </div>
            </form>
        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function applyColumnClasses(colValue) {
