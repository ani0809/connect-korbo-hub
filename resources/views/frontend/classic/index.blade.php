    ...
    <div class="container">
        <div class="d-flex flex-wrap position-relative">
            ...
            <div class="home-slider">
                ...
                <div class="cibato-carousel dots-inside-bottom" data-autoplay="true" data-infinite="true">
                    @php
...
<section class="mb-2 mb-md-3 mt-3 mt-md-3">
    <div class="container">
        ...
        <div class="bg-white d-sm-none ">
            <div class="cibato-carousel @if (count($classified_products) <= 8) arrow-inactive-none arrow-x-0 @endif"
...
<section class="mb-2 mb-md-3 mt-2 mt-md-3">
    <div class="container">
        ...
        <div class="bg-white px-sm-3 px-0">
            ...
            <div class="d-sm-none cibato-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
                data-xl-items="4" data-lg-items="3.4" data-md-items="2.5" data-sm-items="2" data-xs-items="2.5"
                data-arrows="true" data-dots="false">
                @foreach ($brands as $brand)
