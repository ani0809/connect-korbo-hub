...
@section('content')
    <style>
        ...
        .home-banner-area .cibato-category-menu .sub-cat-menu {
                ...
                <div class="col-lg mt-4">
                    ...
                    @if (get_setting('home_slider_images', null, $lang) != null)
                        <div class="home-slider">
                            <div class="cibato-carousel overflow-hidden rounded-2" data-autoplay="true" data-infinite="true">
                                @php
                    ...
                    @if (count($featured_categories) > 0)
                        <div class="bg-whit mt-4">
                            <div class="cibato-carousel slick-left arrow-inactive-none arrow-x-0" data-items="6.5" data-xxl-items="6.5" data-xl-items="4.5"
                ...
                <div class="rounded-2 overflow-hidden p-3 p-md-2rem @if(get_setting('flash_deal_section_outline') == 1) border @endif" style="background: {{ $flash_deal_bg != null ? $flash_deal_bg : '#fff9ed' }}; border-color: {{ get_setting('flash_deal_section_outline_color') }} !important;">
                    ...
                    <div class="d-flex flex-wrap align-items-baseline justify-content-center justify-content-sm-between mb-2 mb-md-3 position-relative">
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <!-- Countdown -->
                            <div class="cibato-count-down align-items-center ml-2 mb-2 mb-lg-0" data-date="{{ date('Y/m/d H:i:s', $flash_deal->end_date) }}"></div>
                        </div>
                    ...
                    <div class="row gutters-16 align-items-center">
                        ...
                        <div class="col">
                            ...
                            @endphp
                            <div class="pr-md-3">
                                <div class="cibato-carousel gutters-16 arrow-inactive-none arrow-x-0"
                                ...
                                @foreach ($flash_deal_products as $key => $flash_deal_product)
                                    <div class="carousel-box position-relative has-transition hov-animate-outline">
                                        @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                            ...
                                            @endphp
                                            <div
                                                class="cibato-card-box h-180px h-md-200px h-lg-280px flash-deal-item position-relative text-center">
                                                <a href="{{ $product_url }}"
                            ...
                            <div class="row gutters-16">
                                @foreach ($classified_products as $key => $classified_product)
                                    <div
                                        ...
                                        <div class="cibato-card-box py-2 has-transition">
