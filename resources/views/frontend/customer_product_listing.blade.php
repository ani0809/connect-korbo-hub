            ...
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                        ...
                        <div class="cibato-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                <div class="d-flex d-xl-none justify-content-between align-items-center pl-3 border-bottom">
                                    ...
                                    <button type="button" class="btn btn-sm p-2 filter-sidebar-thumb" data-toggle="class-toggle" data-target=".cibato-filter-sidebar" type="button">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="text-left">
                            <div class="d-flex">
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-md-block">
                                    <select class="form-control form-control-sm cibato-selectpicker rounded-0" name="condition" onchange="filter()">
                                ...
                                <div class="form-group ml-2 mr-0 w-200px d-none d-md-block">
                                    <select class="form-control form-control-sm cibato-selectpicker rounded-0" data-live-search="true" name="brand" onchange="filter()">
                        ...
                        <!-- Pagination -->
                        <div class="cibato-pagination cibato-pagination-center mt-4">
