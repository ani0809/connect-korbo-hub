            ...
            <div class="row gutters-15">
                <div class="col" id="section_featured_div">
                    <div class="border">
                        ...
                        <!-- Products Section -->
                        <div class="px-xl-1">
                            <div class="cibato-carousel arrow-none" data-items="{{ $xxl_items }}" data-xl-items="{{ $xl_items }}" data-lg-items="{{ $lg_items }}"  data-md-items="{{ $md_items }}" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
