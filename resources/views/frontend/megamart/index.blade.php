        ...
        <section class="mb-3 mb-md-4 pt-3 pt-md-2rem">
            <div class="container">
                ...
                <div class="bg-white px-sm-3">
                    <div class="cibato-carousel sm-gutters-17" data-items="8" data-xxl-items="8" data-xl-items="8"
        ...
        <div class="@if(get_setting('slider_section_full_width') == 1) p-0 @else container @endif">
            ...
            <div class="home-slider slider-full">
                @if (get_setting('home_slider_images', null, $lang) != null)
                    <div class="cibato-carousel dots-inside-bottom mobile-img-auto-height" data-autoplay="true" data-infinite="true">
                        @php
            ...
            <div class="container">
                <div class="@if(!$flash_deal_bg_full_width) px-3 px-md-2rem @endif pb-3 pb-md-4" style="background: {{ $flash_deal_bg != null ? $flash_deal_bg : '#faf9f7' }};">
                    ...
                    <div class="d-flex flex-wrap align-items-baseline justify-content-center justify-content-sm-between mb-2 mb-md-3 pt-2 pt-md-3 position-relative">
                        ...
                        <!-- Countdown -->
                        <div class="cibato-count-down-box-div">
                            <div class="cibato-count-down-box align-items-center mb-2 mb-lg-0" data-date="{{ date('Y/m/d H:i:s', $flash_deal->end_date) }}"></div>
                        </div>
                        <!-- Links -->
                        <div>
                    ...
                    <div class="row no-gutters align-items-center border" style="background: {{ $flash_deal_bg }};">
                        ...
                        <div class="col-xxl-10 col-md-9 col-sm-8 col-7">
                            ...
                            @endphp
                            <div class="cibato-carousel arrow-inactive-none arrow-x-0"
    ...
    @if ($homepreorder_banner_1Images != null)
        <div class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                @endphp
                <div class="cibato-carousel gutters-16 overflow-hidden arrow-inactive-none arrow-dark arrow-x-15"
        ...
        <div class="row gutters-16">
            ...
            @if ($homeBanner3Images != null)
                <div class="col-xl-4 mb-2 mb-md-3 mt-2 mt-md-3 d-none d-xl-block">
                    ...
                    @endphp
                    <div class="cibato-carousel overflow-hidden arrow-inactive-none arrow-dark arrow-x-0"
                    ...
                    <div class="col mb-2 mb-md-3 mt-2 mt-md-3">
                        <div class="h-100" id="section_top_sellers">
                            <div class="border px-3 py-2rem">
                                ...
                                <!-- Sellers Section -->
                                <div class="cibato-carousel arrow-x-0 arrow-inactive-none" data-rows="{{ $data_rows }}" data-items="{{ $xxl_items }}" data-xxl-items="{{ $xxl_items }}"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col py-3 py-lg-0">
                        <div class="h-100" id="section_top_brands">
                            <div class="border px-3 pt-3">
                                ...
                                <!-- Brands Section -->
                                <div class="cibato-carousel arrow-x-0 arrow-inactive-none py-4" data-rows="{{ $data_rows }}" data-items="{{ $xxl_items }}" data-xxl-items="{{ $xxl_items }}"
                    ...
                    @if ($homeBanner6Images != null)
                        ...
                        @endphp
                        <div class="{{ $col_val }} d-none d-xl-block"><div class="cibato-carousel overflow-hidden arrow-inactive-none arrow-dark arrow-x-0"
                            data-items="1" data-arrows="true" data-dots="false" data-autoplay="true">
                    ...
                    <div class="border">
                        ...
                        <div class="d-sm-flex bg-white pb-3 pb-md-4">
                            ...
                            <div class="px-0 px-sm-4 w-100 overflow-hidden">
                                <div class="cibato-carousel arrow-x-0 arrow-inactive-none" data-items="5"
