                        ...
                        <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                            ...
                            <div class="card mb-5 border-0 rounded-0 shadow-none">
                                <div class="card-header py-3 px-0 border-bottom-0">
                                    <h5 class="fs-16 fw-700 text-dark mb-0">{{ get_setting('site_name') }} {{ translate('Products') }}</h5>
                                </div>
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-6">
                                                        <label class="cibato-megabox d-block bg-white mb-0">
                                                            <input
                                                                ...
                                                                checked
                                                            >
                                                            <span class="d-flex cibato-megabox-elem rounded-0" style="padding: 0.75rem 1.2rem;">
                                                ...
                                                @if ($pickup_point_list)
                                                    <div class="mt-3 pickup_point_id_admin d-none">
                                                        <select
                                                            class="form-control cibato-selectpicker rounded-0"
                                                ...
                                                @foreach($carrier_list as $carrier_key => $carrier)
                                                    <div class="col-md-12 mb-2">
                                                        <label class="cibato-megabox d-block bg-white mb-0">
                                                            ...
                                                            >
                                                            <span class="d-flex flex-wrap p-3 cibato-megabox-elem rounded-0">
                                                                <span class="cibato-rounded-check flex-shrink-0 mt-1"></span>
                                                            ...
                                                            <div class="col-6">
                                                                <label class="cibato-megabox d-block bg-white mb-0">
                                                                    <input
                                                                        ...
                                                                        checked
                                                                    >
                                                                    <span class="d-flex p-3 cibato-megabox-elem rounded-0" style="padding: 0.75rem 1.2rem;">
                                                                        <span class="cibato-rounded-check flex-shrink-0 mt-1"></span>
                                                                        <span class="flex-grow-1 pl-3 fw-600">{{  translate('Home Delivery') }}</span>
                                                                    </span>
                                                                </label>
