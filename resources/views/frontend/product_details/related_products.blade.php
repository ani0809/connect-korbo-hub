<div class="related-product-container py-20px px-30px border bg-white border-light-gray rounded-2">
    ...
    <div class="cibato-carousel related-products-carousel arrow-x-0 arrow-inactive-none gutters-15" data-items="5" data-xxl-items="5"
        data-xl-items="5" data-lg-items="5" data-md-items="4" data-sm-items="2" data-xs-items="2"
        ...
        <div class="carousel-box">
            @include('frontend.partials.unified_product_card', [
                ...
                'card_padding_class' => 'px-1',
                'image_aspect_ratio' => '1 / 1.12',
