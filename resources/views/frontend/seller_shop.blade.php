    ...
    @if (!isset($type))
        ...
        @if (count($feature_products) > 0)
            <section class="mt-3 mb-3" id="section_featured">
                ...
                <div class="d-flex mb-4 align-items-baseline justify-content-between">
                    ...
                    <!-- Products Section -->
                    <div class="px-sm-3">
                        <div class="cibato-carousel sm-gutters-16 arrow-none featured-products" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2.5" data-xs-items="2.5" data-arrows='true' data-autoplay='true' data-infinute="true">
        ...
        @if ($shop->slider_images != null)
            <section class="mt-3 mb-3">
                <div class="container">
                    <div class="cibato-carousel mobile-img-auto-height" data-arrows="true" data-dots="false" data-autoplay="true">
                        @php
        ...
        @if (count($coupons)>0)
            <section class="mt-3 mb-3" id="section_coupons">
                ...
                <div class="d-flex mb-4 align-items-baseline justify-content-between">
                    ...
                    <!-- Coupons Section -->
                    <div class="cibato-carousel sm-gutters-16 arrow-none" data-items="3" data-lg-items="2" data-sm-items="1" data-arrows='true' data-infinite='false'>
        ...
        <div class="container">
            ...
            @if (!isset($type))
                ...
                <div class="px-sm-3 pb-3">
                    <div class="cibato-carousel sm-gutters-16 arrow-none featured-products" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2.5" data-xs-items="2.5" data-arrows='true' data-infinite='false'>
            ...
            @elseif ($type == 'cupons')
                ...
                <div class="cibato-pagination mt-4 mb-4">
                    {{ $coupons->links() }}
                </div>
                ...
                <form class="" id="search-form" action="" method="GET">
                    <div class="row gutters-16 justify-content-center">
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-8">
                            ...
                            <!-- Sidebar Filters -->
                            <div class="cibato-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                                <div class="overlay overlay-fixed dark c-pointer" data-toggle="class-toggle" data-target=".cibato-filter-sidebar" data-same=".filter-sidebar-thumb"></div>
                                <div class="collapse-sidebar c-scrollbar-light text-left">
                                    <div class="d-flex d-xl-none justify-content-between align-items-center pl-3 border-bottom">
                                        <h3 class="h6 mb-0 fw-600">{{ translate('Filters') }}</h3>
                                        <button type="button" class="btn btn-sm p-2 filter-sidebar-thumb" data-toggle="class-toggle" data-target=".cibato-filter-sidebar" >
                                    ...
                                    <div class="bg-white border mb-4 mx-3 mx-xl-0 mt-3 mt-xl-0">
                                        ...
                                        <div class="collapse show px-3" id="collapse_1">
                                            @foreach (get_categories_by_products($shop->user->id) as $category)
                                                <label class="cibato-checkbox mb-3">
                                                    <input
                                                        type="checkbox"
                                        ...
                                        <div class="collapse show px-3" id="collapse_3">
                                            <div class="row gutters-10">
                                                @foreach (get_brands_by_products($shop->user->id) as $key => $brand)
                                                    <div class="col-6">
                                                        <label class="cibato-megabox d-block mb-3">
                                                            <input value="{{ $brand->slug }}" type="radio" onchange="filter()"
                                                                name="brand" @isset($brand_id) @if ($brand_id == $brand->id) checked @endif @endisset>
                                                            <span class="d-block cibato-megabox-elem rounded-0 p-3 border-transparent hov-border-primary">
                            ...
                            <div class="text-left mb-2">
                                <div class="row gutters-5 flex-wrap">
                                    ...
                                    <div class="col-2 col-lg-auto d-xl-none mb-lg-3 text-right">
                                        <button type="button" class="btn btn-icon p-0" data-toggle="class-toggle" data-target=".cibato-filter-sidebar">
                                            <i class="la la-filter la-2x"></i>
                                        </button>
                                    </div>
                                    <div class="col-6 col-lg-auto mb-3 w-lg-200px">
                                        <select class="form-control form-control-sm cibato-selectpicker rounded-0" name="sort_by" onchange="filter()">
                                ...
                                <div class="bg-white border mb-4 mx-3 mx-xl-0 mt-3 mt-xl-0">
                                 ...
                                 <div class="bg-white border mb-3">
                                    ...
                                    <div class="collapse {{ $show }}" id="collapse_availability_filter">
                                        <div class="p-3 cibato-checkbox-list">
                                            <label class="cibato-checkbox mb-3">
                                                <input
                                                    type="radio"
                                                    name="is_available"
