...
<head>
    ...
    @endif
    <link rel="stylesheet" href="{{ static_asset('assets/css/cibato-core.css?v=') }}{{ rand(1000, 9999) }}">
...
<body>
    <!-- cibato-main-wrapper -->
    <div class="cibato-main-wrapper d-flex flex-column justify-content-center bg-white">
                ...
                <div class="demo-admin-links w-100 py-5 my-lg-5 px-4 mx-auto">
                    <div class="row overflow-hidden rounded-3" style="border: 1px solid #f2f2f2;">
                        <div class="col-md-6 px-0 d-none d-md-block"  style="border-right: 1px solid #f2f2f2;">
                            <img class="img-fit h-100" src="{{ my_asset('assets/img/demo/link/link.png') }}" alt="Cibato Commerce">
                        </div>
                        <div class="col-md-6 px-2rem py-5 d-flex flex-column justify-content-center">
                            <div class="mb-4 text-center">
                                <img class="h-40px" src="{{ my_asset('assets/img/demo/link/logo.svg') }}" alt="Cibato Commerce">
                            </div>
                            <a href="https://demo.cibato.com/ecommerce/users/login" class="btn btn-block btn-lg btn-soft-primary fs-14 fw-700 mb-3 rounded-2">Login as Customer</a>
                            <a href="https://demo.cibato.com/ecommerce/login" class="btn btn-block btn-lg btn-soft-info fs-14 fw-700 mb-3 rounded-2">Login as Admin</a>
                            <a href="https://demo.cibato.com/ecommerce/seller/login" class="btn btn-block btn-lg btn-soft-success fs-14 fw-700 mb-3 rounded-2">Login as Seller</a>
                            <a href="https://demo.cibato.com/ecommerce/deliveryboy/login" class="btn btn-block btn-lg btn-soft-warning fs-14 fw-700 mb-3 rounded-2">Login as Delivery Boy</a>
                    ...
                    <div class="text-center" style="margin-top: 40px;">
                        <small class="d-block fs-12 text-center mb-3" style="color: #78829d;">Mobile Apps for Cibato Commerce</small>
                        <div class="d-flex flex-wrap justify-content-center mb-3">
                            <a href="https://cibato.com/products/customer-app" target="_blank" class="fs-14 fw-700 text-primary mx-3 animate-underline-primary">Customer Mobile App</a>
                            <a href="https://cibato.com/products/seller-app" target="_blank" class="fs-14 fw-700 text-primary mx-3 animate-underline-primary">Seller’s Mobile App</a>
                            <a href="https://cibato.com/products/delivery-app" target="_blank" class="fs-14 fw-700 text-primary mx-3 animate-underline-primary">Delivery Boy Mobile App</a>
                        </div>
                        <div class="mb-5">
                            <a href="https://cibato.com/addons" target="_blank" class="fs-12 fw-500 hov-text-primary" style="text-decoration: underline; text-transform: uppercase;color: #78829d;">View all Add-ons</a>
                        </div>
                        <div class="d-flex flex-wrap justify-content-center mb-2">
                            <a href="https://cibato.com/docs" target="_blank" class="fs-14 fw-700 text-primary mx-4 d-flex align-items-center">
                        ...
                        <div class="">
                            <a href="https://cibato.com/" target="_blank" class="fs-12 hov-text-primary" style="color: #78829d;">www.cibato.com</a>
                        </div>
                    </div>
                </div>
            </div>
