    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body c-scrollbar-light h-300px" id="edit_modal_body">
                <form id="cibatoSubmitForm" class="form-horizontal" action="{{ route('payment_informations.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="payment_type" class="form-control cibato-selectpicker" data-live-search="true">
