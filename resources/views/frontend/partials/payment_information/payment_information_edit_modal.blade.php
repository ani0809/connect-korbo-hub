<form id="cibatoSubmitForm edit-payment-information-modal" class="form-horizontal" action="{{ route('payment_informations.update', $payment_information_data->id) }}" method="POST">
    @csrf
