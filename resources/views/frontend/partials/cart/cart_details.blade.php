                ...
                <div class="bg-white p-3 p-lg-4 text-left">
                    <div class="mb-4">
                        <div class="form-group mb-2 border-bottom">
                            <div class="cibato-checkbox-inline mb-3">
                            ...
                            @if (!empty($admin_products))
                                ...
                                <div class="pt-3 px-0">
                                    <div class="cibato-checkbox-inline">
                                        <label class="cibato-checkbox d-block">
                                            ...
                                            <span class="fs-16 fw-700 text-dark ml-3 pb-3 d-block border-left-0 border-top-0 border-right-0 border-bottom border-dashed">
                                                {{ translate('Products') }} ({{ count($admin_products) }})
                                            </span>
                                            <span class="cibato-square-check"></span>
                                        </label>
                                    </div>
                                ...
                                @foreach ($admin_products as $key => $product_id)
                                    ...
                                    <li class="list-group-item px-0 border-md-0">
                                        <div class="row gutters-5 align-items-center">
                                            <!-- select -->
                                            <div class="col-auto">
                                                <div class="cibato-checkbox pl-0">
                                                    <label class="cibato-checkbox">
                                            ...
                                            <div class="col-xl-4 col-md-3 col d-flex flex-column flex-xl-row justify-content-xl-between align-items-xl-center">
                                                ...
                                                <div>
                                                    @if ($product->digital != 1 && $product->auction_product == 0)
                                                        <div class="d-flex flex-xl-column flex-xxl-row align-items-center cibato-plus-minus mr-0 ml-0" style="width: max-content !important;">
                                                            <button
