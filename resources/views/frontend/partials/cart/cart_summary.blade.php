...
@endphp
<div class="z-3 sticky-top-lg {{ $embedded ? '' : '' }}">
    <div class="card rounded-0 {{ $embedded ? 'border-0 shadow-none bg-transparent' : 'border' }}">
        ...
        <div class="card-header {{ $embedded ? 'pt-2' : 'pt-4' }} pb-1 border-bottom-0 {{ $embedded ? 'px-0 bg-transparent' : '' }}">
        ...
        <div class="card-body pt-2 {{ $embedded ? 'px-0 pb-0' : '' }}">
