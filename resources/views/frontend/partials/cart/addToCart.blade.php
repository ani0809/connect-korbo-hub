    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="row gutters-10 flex-row-reverse">
                ...
                @endphp
                <div class="col">
                    <div class="cibato-carousel product-gallery" data-nav-for='.product-gallery-thumb' data-fade='true' data-auto-height='true'>
                ...
                <div class="col-auto w-90px">
                    <div class="cibato-carousel carousel-thumb product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-focus-select='true'>
                        @foreach ($photos as $key => $photo)
                                ...
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-9">
                                        <div class="cibato-radio-inline">
                                            ...
                                            <label class="cibato-megabox pl-0 mr-2 mb-0">
                                                <input
                                                    type="radio"
                                                ...
                                                >
                                                <span class="cibato-megabox-elem rounded-0 d-flex align-items-center justify-content-center py-1 px-3">
                                                    {{ $value }}
                                                </span>
                                            </label>
                                            @endforeach
                            ...
                            <div class="row no-gutters mt-3">
                                ...
                                <div class="col-9">
                                    <div class="cibato-radio-inline">
                                        ...
                                        <label class="cibato-megabox pl-0 mr-2 mb-0" data-toggle="tooltip" data-title="{{ get_single_color_name($color) }}">
                                            <input
                                                type="radio"
                                                name="color"
                                                ...
                                                @if($key == 0) checked @endif
                                            >
                                            <span class="cibato-megabox-elem rounded-0 d-flex align-items-center justify-content-center p-1">
                        ...
                        <div class="row no-gutters mt-3">
                            ...
                            <div class="col-9">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center cibato-plus-minus mr-3" style="width: 130px;">
