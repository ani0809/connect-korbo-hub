<!-- Demo nav -->
<div class="cibato-demo-nav">
    <!-- Mobile bottom nav toggler-->
    <div class="bg-white position-relative">
        <a href="javascript:void(0);" class="position-relative cibato-demo-nav-item cibato-demo-nav-toggler">
            <div class="cibato-demo-nav-btn">
    ...
    <!-- Mobile bottom nav toggler-->
    <div class="cibato-demo-nav-links">
        <a href="https://cibato.com/docs" class="cibato-demo-nav-item" target="_blank">
        ...
        <a href="https://www.youtube.com/watch?v=FFjausSYe3M" class="cibato-demo-nav-item" target="_blank">
        ...
        <a href="https://www.youtube.com/watch?v=zW6FwRsaxDk" class="cibato-demo-nav-item" target="_blank">
...
<!-- Demo content -->
<div class="cibato-demos">
    <div class="cibato-demo-content">
        <div class="px-2rem">
            <div class="row gutters-16">
                <!-- Main Demo -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce/" target="_blank" class="h-100 w-100">
                            <img src="{{ static_asset('assets/img/demo/demo_thumb_main.png') }}">
                        </a>
                    </div>
                    <p class="demo-title">{{ translate('Main Demo') }}</p>
                </div>
                <!-- Grocery Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-grocery/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-electronics/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-fashion/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-automobile/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-furniture/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-medical/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-sports/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-construction/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-megamart/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.cibato.com/ecommerce-beauty-store/" target="_blank" class="h-100 w-100">
