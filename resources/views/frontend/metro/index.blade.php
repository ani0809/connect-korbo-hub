        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3" style="background: {{ ($flash_deal_bg_full_width && $flash_deal_bg != null) ? $flash_deal_bg : '' }};" id="flash_deal">
            <div class="container">
                ...
                <div class="bg-white mb-3 d-md-none">
                    <div class="cibato-count-down-circle" end-date="{{ date('Y/m/d H:i:s', $flash_deal->end_date) }}"></div>
                </div>
                ...
                <div class="row no-gutters align-items-center" style="background: {{ $flash_deal_bg }};">
                        ...
                        <a href="{{ route('flash-deal-details', $flash_deal->slug) }}">
                            <div class="h-100 w-100 w-xl-auto"
                                ...
                                <div class="py-5 px-md-3 px-xl-5 d-none d-md-block">
                                    <div class="bg-white">
                                        <div class="cibato-count-down-circle"
                    ...
                    <div class="col-xxl-8 col-lg-7 col-6">
                        <div class="pl-3 pr-lg-3 pl-xl-2rem pr-xl-2rem">
                            ...
                            @endphp
                            <div class="cibato-carousel border-top @if (count($flash_deal_products) > 8) border-right @endif arrow-inactive-none arrow-x-0"
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                <div class="bg-white px-sm-3">
                    <div class="cibato-carousel sm-gutters-17" data-items="4" data-xxl-items="4" data-xl-items="3.5"
                        ...
                        <div class="row no-gutters border-top border-left">
                            @foreach ($classified_products as $key => $classified_product)
                                <div
                                    ...
                                    <div class="cibato-card-box p-2 has-transition bg-white">
    ...
    @if (get_setting('vendor_system_activation') == 1)
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                <!-- Sellers Section -->
                <div class="cibato-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
