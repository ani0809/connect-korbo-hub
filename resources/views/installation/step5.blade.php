            ...
            <div class="card install-card position-relative">
                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                    ...
                    <div class="mar-ver pad-btm text-center">
                        ...
                        <h1 class="fs-21 fw-700 text-uppercase mt-2" style="color: #3d3d3d;">Cibato Commerce Settings</h1>
                    ...
                    <form method="POST" action="{{ route('system_settings') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control rounded-2 border cibato-selectpicker" style="height: 36px !important;" data-live-search="true" name="system_default_currency" required>
