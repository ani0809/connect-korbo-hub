                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                  <!-- Top content -->
                    <div class="mar-ver pad-btm text-center">
                        ...
                        <h1 class="fs-21 fw-700 text-uppercase mt-2" style="color: #3d3d3d;">Cibato License</h1>
                        <p class="fs-12 fw-500" style="color:  #666; line-height: 18px;">
                            Provide your Cibato license credentials.<br>
                            <a href="https://licensing.cibato.com/help" target="_blank" class="text-blue hov-text-primary"><i>Where to get license details?</i></a>
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('purchase.code') }}">
                        ...
                        <div class="form-group mb-3">
                            <label for="purchase_code" class="fs-12 fw-500" style="color: #666;">License Code</label>
                        ...
                        <div class="form-group">
                            <label for="system_key" class="fs-12 fw-500" style="color: #666;">License Key</label>
                            ...
                            <p class="text-right fs-11">After activation you will receive your license key.</p>
                        </div>
