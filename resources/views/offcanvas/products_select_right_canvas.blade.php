...
<div class="right-offcanvas-body position-absolute h-100 px-30px">
    <div class="pb-5px">
        ...
        <div class="row gutters-5 mt-3">
            <div class="col-md-6">
                <select class="form-control cibato-selectpicker" name="selected_Products_category" onchange="filterProductByCategory()" data-placeholder="{{ translate('Select a Category')}}" data-live-search="true">
