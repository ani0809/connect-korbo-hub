        ...
        function update_published(el) {
            ...
            $.post('{{ route('seller.preorder-product.published') }}', {
                ...
                if (data == 1) {
                    ...
                    CIBATO.plugins.notify('danger', '{{ translate('Please upgrade your package.') }}');
                } 
                else if(data == 3){
                    CIBATO.plugins.notify('warning', '{{ translate('GST verification is pending for your account.') }}');
                } 
                else if(data == 4){
