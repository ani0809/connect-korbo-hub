                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control cibato-tag-input" name="tags[]" id="tags" value="{{ $product->tags }}" placeholder="{{ translate('Type to add a tag') }}" data-role="tagsinput">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <small class="text-muted">{{translate('Upload a primary image at 500x500 pixels for quick preview. [e.g. A front view of the product.]')}}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="discount-settings">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control cibato-date-range" name="date_range"
                        ...
                        <div class="coupons">
                            ...
                            <div id="couponBlock" style="display: {{$product->is_coupon ? 'block' : 'none' }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control cibato-date-range" name="coupon_date_range" 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <select class="form-control cibato-selectpicker" name="coupon_type">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="available_date_group" style="{{ $product->is_available == 1 ? 'display: none;' : 'display: flex;' }}">
                            ...
                            <div class="col col-from-label">
                                <input type="date" class="form-control cibato-date" name="available_date" placeholder="{{translate('Select Date')}}" 
...
<script type="text/javascript">
    ...
    function filterPreOrderProduct() {
        ...
        $.post('{{ route('preorder_product.search') }}', { _token: CIBATO.data.csrf, product_id: null, search_key:searchKey, category:preOrderCategory }, function(data){
            $('#pre-order-product-list').html(data);
            CIBATO.plugins.sectionFooTable('#pre-order-product-list');
        });
    }
    ...
    function addPreOrderProduct() {
        ...
        $.post('{{ route('get-selected-preorder-products') }}', { _token: CIBATO.data.csrf, product_ids:productIds}, function(data){
            $('#pre-order-product-select-modal').modal('hide');
            $('#selected-pre-order-products-div').html(data);
            CIBATO.plugins.sectionFooTable('#selected-pre-order-products-div');
        });
    }
