                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xxl-8">
                                <input type="text" class="form-control cibato-tag-input" name="tags[]" placeholder="{{ translate('Type and hit enter to add a tag') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="available_date_group">
                            ...
                            <div class="col col-from-label">
                                <input type="date" class="form-control cibato-date" name="available_date" placeholder="{{translate('Select Date')}}" autocomplete="off">
                                <span></span>
                            </div>
                            <small class="col-md-12 col-from-label text-muted">
...
<script type="text/javascript">
    ...
    function filterFqBoughtProduct() {
        ...
        $.post('{{ route('seller.product.search') }}', { _token: CIBATO.data.csrf, product_id: null, search_key:searchKey, category:fqBroughCategory, product_type:"physical" }, function(data){
