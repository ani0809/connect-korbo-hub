        ...
        <div class="mx-4 mt-4">
            ...
            <div class="row align-items-center mt-4">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group mb-0">
                                <input type="text" class="cibato-date-range form-control form-control-sm" value="{{ $date }}"
                ...
                <div class="col-3 text-end">
                    <div class="row">
                        <div class="col-lg-8">
                            <select class="form-control form-control-sm cibato-selectpicker" id="bulk_action">
            ...
            <table class="table cibato-table mb-0">
                <thead>
                    <tr>
                        ...
                        @if($routeName != 'store_preorder.list')
...
<script type="text/javascript">
    ...
    function bulk_delete() {
        ...
        $.post('{{ route('bulk-preorder-delete') }}', { _token: '{{ csrf_token() }}', order_ids: orderIds }, function(data) {
            if (data == 1) {
                CIBATO.plugins.notify('success', '{{ translate('Orders deleted successfully') }}');
            } else {
    ...
    function bulk_prepayment_final_preorder_reminder(){
        ...
        if(orderIds.length > 0){
            ...
            CIBATO.plugins.notify('danger', '{{ translate('Please Select Preorder first.') }}');
        }
    }
