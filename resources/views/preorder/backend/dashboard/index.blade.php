                    ...
                    <div class="dashboard-box border p-4 h-md-360px">
                        <div class="row">
                            <div class="col-lg-6 col-xs-12" >
                                ...
                                <div class="border-bottom-dashed mt-3">
                                    <p class="fs-14 fw-400 mb-0 pb-1">{{translate('Products preorder sales')}}</p>
            ...
            <div class="dashboard-box bg-white mb-2rem  p-2rem" >
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <ul class="nav nav-tabs dashboard-tab dashboard-tab-gunmetal-blue border-0" role="tablist"
                        ...
                        <li class="nav-item">
                            <a class="nav-link preorder_by_products_tab fs-12 fw-700 px-4 py-2 rounded-3" id="preorder-dash-products-tab" href="#preorder-dash-products"
                                data-toggle="tab" data-target="store" type="button" role="tab"
                                aria-controls="preorder-dash-products" aria-selected="true">
                                {{ translate('Products') }}
                            </a>
                        </li>
...
<script>
    ...
    CIBATO.plugins.chart('#yearlySaleChart', {
        type: 'bar',
        data: {
    ...
    CIBATO.plugins.chart('#preorderStatesChart', {
        type: 'bar',
        data: {
            labels: [
    ...
    function preorder_by_products_tab(user_type) {
        ...
        $.ajax({
            ...
            type: "POST",
            url: CIBATO.data.appUrl + "/admin/preorder/dashboard/preorder-by-products-section",
