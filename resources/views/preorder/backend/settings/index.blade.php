                ...
                <form action="{{ route('business_settings.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <textarea name="preorder_request_instruction" rows="4" class="cibato-text-editor form-control" 
                ...
                <form action="{{ route('business_settings.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <textarea name="pre_payment_instruction" rows="4" class="cibato-text-editor form-control" 
                                data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]'>
