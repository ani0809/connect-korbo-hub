                ...
                <div class="row">
                        ...
                        <div class="badges ">
                            <div class="d-flex">
                                ...
                                <div class="bg-light rounded-1">
                                    ...
                                    <a href="javascript:void(0);" class="badge badge-inline {{ in_array($type, ['store', 'in_house', 'inhouse'], true) ? $activeClasss : $inActiveClasses}}" onclick="sort_product_by_user('store')">{{ translate('Products') }}({{ $inHouseProductCount }})</a>
                    ...
                    <div class="col-12 mt-4">
                        <div class="row ml-0">
                            ...
                            @endcan
                            <div class="col-lg-2">
                                <select class="form-control form-control-sm cibato-selectpicker" name="type" onchange="sort_products()">
                            ...
                            @if (auth()->user()->can('product_delete'))
                                <th>
                                    <div class="form-group">
                                        <div class="cibato-checkbox-inline">
                        ...
                        @foreach ($products as $key => $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div>
                                        <span class="text-muted text-truncate-2 text-info">{{ $product->user->user_type != 'seller' ? translate('Products') : $product->user->shop->name }}</span>
                                ...
                                <td>
                                    <div class="mb-2">
                                        ...
                                        <label class="cibato-switch cibato-switch-success mb-0 mt-2">
    ...
    <script type="text/javascript">
        ...
        function update_published(el) {
            ...
            $.post('{{ route('preorder-product.published') }}', {
                ...
                if (data == 1) {
                    CIBATO.plugins.notify('success', '{{ translate('Published product updated successfully') }}');
                } else if(data == 3){
                    CIBATO.plugins.notify('danger', '{{ translate('GST verification is pending for this shop.') }}');
                }
                else if(data == 4){
        ...
        function update_approval(el) {
            ...
            $.post('{{ route('preorder-product.approval') }}', {
                ...
                if (data == 1) {
                    CIBATO.plugins.notify('success', '{{ translate('Product approval updated successfully') }}');
                } else {
                    CIBATO.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
            });
        ...
        function update_featured(el) {
            ...
            $.post('{{ route('preorder-product.featured') }}', {
                ...
                if (data == 1) {
                    CIBATO.plugins.notify('success', '{{ translate('Featured product updated successfully') }}');
                } else {
                    CIBATO.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
            });
        ...
        function bulk_delete() {
            ...
            $.post('{{ route('preorder-product.bulk-destroy') }}', {
                ...
                if (data == 1) {
                    CIBATO.plugins.notify('success', '{{ translate('Products deleted successfully') }}');
                } else {
                    CIBATO.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
                location.reload();
