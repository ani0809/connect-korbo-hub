                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control cibato-selectpicker" name="category_id" id="category_id" data-live-search="true" required>
                        ...
                        <div class="form-group row" id="brand">
                            ...
                            <div class="col-md-8">
                                <select class="form-control cibato-selectpicker" name="brand_id" id="brand_id" data-live-search="true">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="cibatouploader" data-type="image" data-multiple="true">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Thumbnail Image')}} <small>(500x500)</small></label>
                            <div class="col-md-8">
                                ...
                                <small class="text-muted">{{translate('This image is visible in all product box. Use 500x500 sizes image. Keep some blank space around main object of your image as we had to crop some edge in different devices to make it responsive.')}}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Video Provider')}}</label>
                            <div class="col-md-8">
                                <select class="form-control cibato-selectpicker" name="video_provider" id="video_provider">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="cibato-text-editor" name="description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- ====================Prepayment================= -->
                    <div class="prepayment">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label class="cibato-switch cibato-switch-success mb-0">
...
<!-- ====================Discount Settings================= -->
                    <div class="discount-settings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control cibato-date-range" name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <select class="form-control cibato-selectpicker" name="discount_type">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <select class="form-control cibato-selectpicker" name="after_preorder_discount_type">
                                            <option value="amount">{{translate('Flat')}}</option>
                                            <option value="percent">{{translate('Percent')}}</option>
                                        </select>
                                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <select class="form-control cibato-selectpicker" name="direct_purchase_discount_type[]">
                                            <option value="amount">{{translate('Flat')}}</option>
                                            <option value="percent">{{translate('Percent')}}</option>
                                        </select>
                                    </div>
...
<!-- ====================Coupons================= -->
                    <div class="coupons">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                               <div class="row">
                                <label class="col-sm-3 cibato-switch cibato-switch-success mb-0">
                                    <input type="checkbox" name="is_published" value="1">
                                    <span></span>
                                </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control cibato-date-range" name="coupon_date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                                  </div>
                               </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <select class="form-control cibato-selectpicker" name="campaign" id="campaign" data-live-search="true">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="col-md-6 ms-auto">
                                        <label class="cibato-switch cibato-switch-success mb-0 ms-auto">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                <div class="form-group row">\
                    ...
                    <div class="col-md-8">\
                        <select class="form-control cibato-selectpicker attribute_choice" data-live-search="true" name="choice_options_'+ i +'[]" data-selected-text-format="count" multiple>\
                            '+obj+'\
                        </select>\
                    </div>\
                </div>');
