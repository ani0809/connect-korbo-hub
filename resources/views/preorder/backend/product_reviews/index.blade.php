    ...
    <form class="" action="" id="sort_reiewed_products" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div class="col-lg-2 ml-auto">
                <select class="form-control form-control-sm cibato-selectpicker" name="seller_id" id="seller_id" onchange="sort_reiewed_products()" data-selected="{{ $sellerID }}" >
                    <option value="all">{{ translate('All') }}</option>
                    <option value="{{ get_admin()->id }}">{{ translate('Products') }}</option>
            ...
            <div class="col-lg-2">
                <select class="form-control form-control-sm cibato-selectpicker" name="rating" id="rating" onchange="sort_reiewed_products()" data-selected="{{ $sortByRating }}">
