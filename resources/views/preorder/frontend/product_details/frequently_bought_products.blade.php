<div class="bg-white border rounded-2">
    ...
    <div class="px-4">
        <div class="cibato-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3" data-lg-items="4"
            ...
            <div class="carousel-box">
                <div class="cibato-card-box hov-shadow-md my-2 has-transition hov-scale-img">
                    <div class="">
