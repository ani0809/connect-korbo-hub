    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    <label class="cibato-switch cibato-switch-success mb-3">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control cibato-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="country_id" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 cibato-selectpicker" data-live-search="true" name="state_id" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 cibato-selectpicker" data-live-search="true" name="city_id" required>
                        ...
                        <div class="row area-field d-none">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 cibato-selectpicker rounded-0" data-live-search="true" name="area_id">
...
<script type="text/javascript">
    $('.new-email-verification').on('click', function() {
        ...
        $.post('{{ route('user.email.update.verify.code') }}', {_token:'{{ csrf_token() }}', email: email}, function(data){
                ...
                if (data.status == 2){
                    CIBATO.plugins.notify('warning', data.message);
                }
                else if (data.status == 1){
                    CIBATO.plugins.notify('success', data.message);
