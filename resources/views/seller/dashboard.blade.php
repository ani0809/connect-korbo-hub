...
@section('panel_content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="cibato-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"
                data-md-items="3" data-sm-items="2" data-arrows='true'>
                @foreach ($products as $key => $product)
                    <div class="carousel-box">
                        <div
                            class="cibato-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                ...
                <div class="modal-body c-scrollbar-light seller-verification-form">
                    ...
                    <form action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data" id="seller-verification-form">
                        ...
                        <div class="form-group">
                            ...
                            <select
                                class="form-control cibato-selectpicker bg-soft-light rounded-2"
