...
@section('panel_content')
    ...
    <div class="card">
        <div class="card-body">
            <table class="table cibato-table mb-0" style="font-size:14px; background-color: #cce5ff; border-color: #b8daff">
                <tr>
                    <td>{{ translate('1. Download the import template and fill it with data.')}}:</td>
                </tr>
                <tr >
                    <td>{{ translate('2. You can download the example file to understand how the data must be filled.')}}:</td>
                </tr>
                <tr>
                    <td>{{ translate('3. Once you have downloaded and filled the template, upload it in the form below and submit.')}}:</td>
                </tr>
                <tr>
