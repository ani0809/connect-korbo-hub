            ...
            <tbody>
                @foreach($categories as $key => $category)
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control cibato-date-range rounded-2" value="{{ $start_date && $end_date ? $start_date . ' to ' . $end_date : '' }}" placeholder="{{translate('Select Date')}}" id="date_range_{{ $category->id }}" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                        </td>
                        <td class="text-right">
