            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group" data-toggle="cibatouploader" data-multiple="false">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control cibato-tag-input" name="tags[]" id="tags" value="{{ $product->tags }}" placeholder="{{ translate('Type to add a tag') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label" for="signinSrEmail">{{translate('Thumbnail Image')}} <small>(500x500)</small></label>
                            <div class="col-lg-9">
                                <div class="input-group" data-toggle="cibatouploader" data-type="image" data-multiple="false">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                    </div>
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @foreach (\App\Models\Tax::where('tax_status', 1)->get() as $tax)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <select class="form-control cibato-selectpicker" name="tax_type[]" required>
...
<script type="text/javascript">
    ...
    function filterFqBoughtProduct() {
        ...
        $.post('{{ route('seller.product.search') }}', { _token: CIBATO.data.csrf, product_id: productID, search_key:searchKey, category:fqBroughCategory, product_type:"digital" }, function(data){
            $('#product-list').html(data);
            CIBATO.plugins.fooTable();
        });
    }
