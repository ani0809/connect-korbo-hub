...
<div class="cibato-titlebar mt-2 mb-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control cibato-tag-input" name="tags[]" id="tags"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="cibatouploader" data-type="video"
                                data-multiple="true">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-soft-secondary font-weight-medium">
                                        {{ translate('Browse') }}</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control cibato-selectpicker" data-live-search="true"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <select name="choice_attributes[]" data-live-search="true" data-selected-text-format="count"
                                id="choice_attributes" class="form-control cibato-selectpicker" multiple
                    ...
                    <div class="customer_choice_options" id="customer_choice_options">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control cibato-selectpicker attribute_choice" data-live-search="true" name="choice_options_{{ $choice_option->attribute_id }}[]" multiple>
                                ...
                                {{-- <input type="text" class="form-control cibato-tag-input" name="choice_options_{{ $choice_option->attribute_id }}[]" placeholder="{{ translate('Enter choice values') }}" value="{{ implode(',', $choice_option->values) }}" data-on-change="update_sku"> --}}
                            </div>
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control cibato-date-range" value="{{ $date_range }}" name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <select class="form-control cibato-selectpicker" name="discount_type" required>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea class="cibato-text-editor"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <div class="input-group" data-toggle="cibatouploader">
                                <div class="input-group-prepend">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <label class="cibato-switch cibato-switch-success mb-0 d-block">
                ...
                <div class="card-body">
                    ...
                    <div class="w-100 warranty_selection_div @if($product->has_warranty != 1) d-none @endif" >
                        <div class="form-group row">
                            <div class="col-md-2"></div>
                            <div class="col-md-10">
                                <select class="form-control cibato-selectpicker" 
                                    name="warranty_id" 
                                    id="warranty_id" 
                                    ...
                                    <div id="selected-fq-bought-products">
                                        @if(count($fq_bought_products) > 0)
                                            <div class="table-responsive mb-4">
                                                <table class="table cibato-table mb-0">
                                                    <thead>
                                                        <tr>
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                <div class="form-group row">\
                    ...
                    <div class="col-md-8">\
                        <select class="form-control cibato-selectpicker attribute_choice" data-live-search="true" name="choice_options_'+ i +'[]" multiple>\
                            '+obj+'\
                        </select>\
                    </div>\
                </div>');
    ...
    function filterFqBoughtProduct() {
        ...
        $.post('{{ route('seller.product.search') }}', { _token: CIBATO.data.csrf, product_id: productID, search_key:searchKey, category:fqBroughCategory, product_type:"physical" }, function(data){
    ...
    function addFqBoughtProduct() {
        ...
        $.post('{{ route('seller.get-selected-products') }}', { _token: CIBATO.data.csrf, product_ids:productIds}, function(data){
