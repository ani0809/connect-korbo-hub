            ...
            <div class="card-body" style="min-height:460px;">
                <form class="form-horizontal" action="{{ route('custom_notification.send') }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control form-control-sm cibato-selectpicker" data-live-search="true"
...
@section('script')
    <script type="text/javascript">
        ...
        $('#select_all').click(function() {
            $('.cibato-selectpicker').selectpicker('selectAll');
        });

        $("#deselect_all").click(function() {
            $('.cibato-selectpicker').selectpicker('deselectAll');
        });
