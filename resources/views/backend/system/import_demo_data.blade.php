				...
				<div class="card-body">
					...
					<form action="{{ route('import_data') }}" method="post" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-xxl-9">
								<select name="layout" class="form-control cibato-selectpicker mb-2 mb-md-0" required>
						...
						<!-- License Code -->
						<div class="form-group row">
							<label class="col-xxl-3 col-from-label fs-13">{{translate('License Code')}} <span class="text-danger">*</span></label>
							<div class="col-xxl-9">
								<input type="text" class="form-control" name="purchase_key" placeholder="{{ translate('Cibato License Code') }}" required>
							</div>
						</div>
						<!-- Domain Name -->
						<div class="form-group row">
