				...
				<div class="card-body">
					<div class="alert alert-info mb-5">
						<ul class="mb-0">
							...
							<li class="">{{ translate('Download latest release package from Cibato panel.') }}</li>
					...
					<form action="{{ route('final_update') }}" method="post" enctype="multipart/form-data">
						...
						<div class="row gutters-5">
							<div class="col-md">
        						<div class="input-group " data-toggle="cibatouploader" data-type="archive">
						...
						<div class="row gutters-5 mt-3">
							<div class="col-md">
		                        <div class="form-group">
		                            <label for="purchase_code" class="fs-12 fw-700" style="color: #666;">License Code. <a class="fs-12 fw-500" href="https://licensing.cibato.com/help" target="_blank" class="text-blue hov-text-primary"><i>Where to get license code?</i></a></label>
						...
						<div class="row gutters-5">
							<div class="col-md">
		                        <div class="form-group">
		                            <label for="system_key" class="fs-12 fw-700" style="color: #666;">License Key. <span class="fs-12 fw-500">If you don't have License Key, <a href="https://licensing.cibato.com" target="_blank" class="text-blue hov-text-primary"><i>Click Here</i></a></span> </label>
