            ...
            <form class="" id="sort_orders" action="" method="GET">
                <div class="card-header row border-0 align-items-center bg-white">
                    ...
                    <div class="col-md-4 offset-md-4 inner-select input-group mt-2 mt-md-0 border border-light bg-light rounded-1 px-0">
                        <input type="text" class="cibato-date-range form-control form-control-sm border-0 px-2 bg-transparent" 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.cibato-date-range').on('cancel.daterangepicker', function(ev, picker) {
            $(this).val('');
            $('#sort_orders').submit();
        });
        $('#sort_orders').on('submit', function() {
            $(this).find('button[type=submit]').prop('disabled', true);
            $('#cibato-data-table tbody').html(`
                <tr>
