<div class="card-body">
    <table class="table mb-0" id="cibato-data-table">
        <thead>
            <tr>
                ...
                <th>
                    <div class="form-group">
                        <div class="cibato-checkbox-inline">
                            <label class="cibato-checkbox pt-5px d-block">
        ...
        <tbody>
            ...
            <tr class="data-row">
                <td class="align-middle w-40px">
                    ...
                    <div class="form-group d-inline-block">
                        <label class="cibato-checkbox">
                            ...
                            <span class="cibato-square-check mt-1"></span>
                        </label>
                    </div>
                    @else
                ...
                <td class="hide-sm align-middle" data-label="Owner">
                    ...
                    <a href="{{ $shop->id ? route('sellers.profile', encrypt($shop->id)) : '#' }}" title="{{ $shop->name ?? get_setting('site_name') }}" class="fs-12 fs-md-14 fw-700 d-block">
                        {{ Str::limit($shop->name, 20) ?? get_setting('site_name') }}
                    </a>
                </td>
    ...
    @if($orders->hasPages())
    <div class="cibato-pagination mt-3" id="pagination">
        {{ $orders->links() }}
    </div>
    @endif
</div>