        ...
        <div class="card-body">
                    ...
                    @if ($order->seller_id == $admin_user_id || get_setting('product_manage_by_admin') == 1)
                        ...
                        <div class="col-12 col-md-4 col-xl-4 col-xxl-2 mb-2">
                            ...
                            @if (auth()->user()->can('update_order_payment_status') && $payment_status == 'unpaid')
                                {{-- <select class="form-control cibato-selectpicker" data-minimum-results-for-search="Infinity" id="update_payment_status"> --}}
                                <select class="form-control cibato-selectpicker" data-minimum-results-for-search="Infinity" id="update_payment_status" onchange="confirm_payment_status()">
                        ...
                        <div class="col-12 col-md-4 col-xl-4 col-xxl-2 mb-2">
                            ...
                            @elseif (auth()->user()->can('update_order_delivery_status') && $delivery_status != 'delivered' && $delivery_status != 'cancelled')
                                <select class="form-control cibato-selectpicker" data-minimum-results-for-search="Infinity"
                        ...
                        @if (addon_is_activated('shiprocket') || addon_is_activated('steadfast') || addon_is_activated('pathao') || addon_is_activated('redx'))
                            ...
                            <div class="col-12 col-md-4 col-xl-4 col-xxl-2 mb-2">
                                ...
                                @if ($order->delivery_status == 'pending' || $order->delivery_status == 'confirmed')
                                    ...
                                    @else
                                        <select class="form-control cibato-selectpicker" id="select_shipping_info" name="shipping_system">
                                            <option value="">
            ...
            <div class="row">
                <div class="col-lg-12 table-responsive">
                    <table class="table-bordered cibato-table invoice-summary table">
                        <thead>
    ...
    <script type="text/javascript">
        $('#assign_deliver_boy').on('change', function() {
            ...
            $.post('{{ route('orders.delivery-boy-assign') }}', {
                ...
                CIBATO.plugins.notify('success', '{{ translate('Delivery boy has been assigned') }}');
            });
        });
        $('#update_delivery_status').on('change', function() {
            ...
            $.post('{{ route('orders.update_delivery_status') }}', {
                ...
                CIBATO.plugins.notify('success', '{{ translate('Delivery status has been updated') }}');
                location.reload();
            });
        });
        ...
        function update_payment_status(){
            ...
            $.post('{{ route('orders.update_payment_status') }}', {
                ...
                CIBATO.plugins.notify('success', '{{ translate('Payment status has been updated') }}');
                location.reload();
            });
        }
        ...
        $('#update_tracking_code').on('change', function() {
            ...
            $.post('{{ route('orders.update_tracking_code') }}', {
                ...
                CIBATO.plugins.notify('success', '{{ translate('Order tracking code has been updated') }}');
            });
        });
    </script>
    ...
    <script type="text/javascript">
        ...
        function loadShippingInfoForShiprocket(sellerId) {
            ...
            $.when(
                $.ajax({
                    ...
                    type: 'POST',
                    headers: { 'X-CSRF-TOKEN': CIBATO.data.csrf },
        ...
        $(document).ready(function () {
            ...
            $('#confirm-address').on('click', function () {
                ...
                if (!pickupId || !boxId) {
                    CIBATO.plugins.notify('warning', '{{ translate("Please select pickup address and box size.") }}');
                    return;
                }
        ...
        $(document).ready(function () {
            ...
            $.post("{{ route('shiprocket.couriers') }}", {
                ...
                if (!res.success) {
                    CIBATO.plugins.notify('danger', res.message);
                    return;
                }
        ...
        $('#confirm-awb-btn').on('click', function () {
            ...
            if (!selectedCourierId) {
                CIBATO.plugins.notify('warning', '{{ translate("Please select a courier first.") }}');
                return;
            }
            ...
            $.post("{{ route('shiprocket.assign.awb') }}", {
                ...
                if (res.success) {
                    CIBATO.plugins.notify('success', res.message);
                    location.reload();
                } else {
                    CIBATO.plugins.notify('danger', res.message);
                }
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#confirm-store').on('click', function () {
                    ...
                    if (!storeId) {
                        CIBATO.plugins.notify('warning', '{{ translate("Please select store") }}');
                        return;
                    }
        ...
        <script>
            ...
            $(document).on('click', '#confirm-redx', function () {
                ...
                if (!pickupStoreId || !areaId) {
                    CIBATO.plugins.notify('warning', 'Please select pickup store and delivery area');
                    return;
                }
                ...
                $.ajax({
                    ...
                    error: function () {
                        CIBATO.plugins.notify('danger', 'RedX API error');
                    }
                });
            });
        </script>
