...
@section('script')
    <script type="text/javascript">
        ...
        function setDiscount(){
            ...
            if(commission < 0) {
                CIBATO.plugins.notify('danger', '{{ translate('Commission can not be less than 0') }}');
            }
            else{
                $.post('{{ route('categories_wise_commission.update') }}', {
                    ...
                    if(data == 1){
                        CIBATO.plugins.notify('success', '{{ translate('Category Wise Commission Set Successfully') }}');
                    }
                    location.reload();
                }).fail(function() {
