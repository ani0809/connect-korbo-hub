        ...
        <div class="card-header row gutters-5">
            ...
            @if($route == 'all_seller_route')
                ...
                <div class="col-lg-2 ml-auto">
                    <select class="form-control cibato-selectpicker" name="verification_status" onchange="sort_sellers()" data-selected="{{ $verification_status }}">
                ...
                <div class="col-md-2 ml-auto">
                    <select class="form-control cibato-selectpicker" name="approved_status" id="approved_status" onchange="sort_sellers()">
    ...
    <script type="text/javascript">
        ...
        function update_approved(el){
            ...
            $.post('{{ route('sellers.approved') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    CIBATO.plugins.notify('success', '{{ translate('Approved sellers updated successfully') }}');
                }
                else{
        ...
        function set_bulk_commission(){
            ...
            if(sellerIds.length > 0){
                ...
                CIBATO.plugins.notify('danger', '{{ translate('Please Select Seller first.') }}');
            }
        }
