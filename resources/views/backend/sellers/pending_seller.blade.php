...
<script>
    function update_approved(el){
        ...
        $.post('{{ route('sellers.registration.approved') }}', {
            ...
            if (data == 1) {
                CIBATO.plugins.notify('success', '{{ translate('Pending sellers Approved successfully') }}');
    ...
    function update_registration_verification_approval(shop_id){
        ...
        $.post('{{ route('sellers.registration.approved') }}', {
            ...
            if (data == 1) {
                CIBATO.plugins.notify('success', '{{ translate('Unverified sellers Verified successfully') }}');
