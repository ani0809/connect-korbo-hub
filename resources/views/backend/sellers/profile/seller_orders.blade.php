...
<div class=" mt-2">
    <form class="" id="sort_orders" action="" method="GET">
        <div>
            <table class="table cibato-table inv-table-2 mb-0">
                <thead>
                    <tr>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                        ...
                                        @php
                                            ...
                                            if (Route::currentRouteName() == 'store_orders.index') {
                                                $order_detail_route = route('store_orders.show', encrypt($order->id));
                                            }
                                        @endphp
            ...
            <div class="cibato-pagination inv-pagination mt-4">
