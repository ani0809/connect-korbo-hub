    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pickup_address.store') }}" method="POST" id="cibatoSubmitForm">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="courier_type" class="form-control cibato-selectpicker" data-live-search="true">
