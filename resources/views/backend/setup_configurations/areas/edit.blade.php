          ...
          <div class="card-body p-0">
              ...
              <form class="p-4" action="{{ route('areas.update', $area->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <select class="select2 form-control cibato-selectpicker" id="state_id" name="state_id" data-toggle="select2" data-placeholder="{{ translate('Choose ...') }}" data-live-search="true" required>
                  ...
                  <div class="form-group">
                      ...
                      <select class="select2 form-control cibato-selectpicker" id="country_id" name="country_id" data-toggle="select2" data-placeholder="{{ translate('Choose ...') }}" data-live-search="true" required>
                  ...
                  <div class="form-group">
                      ...
                      <select class="select2 form-control cibato-selectpicker" id="city_id" name="city_id" data-toggle="select2" data-placeholder="{{ translate('Choose ...') }}" data-live-search="true" required>
