              ...
              <form class="p-4" action="{{ route('cities.update', $city->id) }}" method="POST" enctype="multipart/form-data">
                 ...
                 @if (get_setting('has_state') == 1)
                  <div class="form-group">
                      ...
                      <select class="select2 form-control cibato-selectpicker" name="state_id" data-selected="{{ $city->state_id }}" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true" required>
                  ...
                  <div class="form-group">
                      ...
                      <select class="select2 form-control cibato-selectpicker" name="country_id" data-selected="{{ $city->country_id }}" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true" required>
