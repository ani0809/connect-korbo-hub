    			...
    			<div class="card-body">
    				<form action="{{ route('cities.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control cibato-selectpicker" name="state_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true" required>
                                @foreach ($states as $state)
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control cibato-selectpicker" name="country_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true" required>
                                @foreach ($countries as $country)
    ...
    <script type="text/javascript">
        ...
        function update_status(el){
            ...
            $.post('{{ route('cities.status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    CIBATO.plugins.notify('success', '{{ translate('City status updated successfully') }}');
                }
                else{
