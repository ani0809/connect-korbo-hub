                ...
                <div class="card-body">
                   <form  id="carrier-form">
                        ...
                        <div class="form-group row" id="billing_type_section">
                            ...
                            <div class="col-md-9">
                                <select class="form-control cibato-selectpicker" name="billing_type" onchange="update_price_range_form()" data-selected="{{ $carrier->carrier_ranges->first()->billing_type ?? '' }}"  id="billing_type" data-live-search="true">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($zones as $key => $zone)
                                        <tr>
                                            ...
                                            @endphp
                                            <td>
                                                <input class="cibato-square-check zone_enable mt-2" type="checkbox" name="zones[]" value="{{ $zone->id }}" @if(in_array($zone->id, $selected_zones)) checked @endif>
                                            </td>
