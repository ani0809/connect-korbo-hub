                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control cibato-selectpicker mb-2 mb-md-0" name="CACHE_DRIVER">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control cibato-selectpicker mb-2 mb-md-0" name="SESSION_DRIVER">
    ...
    <script type="text/javascript">
        function updateSettings(el, type, value_type){ 
            ...
            if (
                ...
                CIBATO.plugins.notify('info', value_type.toUpperCase() + ' ' + notifyMessage);
                return;
            }
