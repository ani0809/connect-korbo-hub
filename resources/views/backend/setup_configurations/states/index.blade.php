    			...
    			<div class="card-body">
    				<form action="{{ route('states.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control cibato-selectpicker" name="country_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                @foreach (\App\Models\Country::where('status', 1)->get() as $country)
    ...
    <script type="text/javascript">
        ...
        function update_status(el){
            ...
            $.post('{{ route('states.status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    CIBATO.plugins.notify('success', '{{ translate('State status updated successfully') }}');
                }
                else{
