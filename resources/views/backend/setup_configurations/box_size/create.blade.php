    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('shipping_box_size.store') }}" method="POST" id="cibatoSubmitForm">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="col-from-label fs-13">
                                {{translate('Courier Type')}}<span class="text-danger"> *</span>
                            </label>
                            <select name="courier_type" class="form-control cibato-selectpicker"
