                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="products[]" id="products" class="form-control cibato-selectpicker" multiple required
    ...
    document.addEventListener("submit", function(e) {
        ...
        if (checkbox.checked) {
            ...
            if (!minInput.value || !maxInput.value) {
                e.preventDefault();
                CIBATO.plugins.notify('danger', '{{ translate('Both Minimum and Maximum Interval are required.') }}');
                return;
            }
            ...
            if (!Number.isInteger(min) || !Number.isInteger(max)) {
                e.preventDefault();
                CIBATO.plugins.notify('danger', '{{ translate('Only integer values are allowed for intervals.') }}');
                return;
            }
            ...
            if (min > max) {
                e.preventDefault();
                CIBATO.plugins.notify('danger', '{{ translate('Minimum Interval cannot be greater than Maximum.') }}');
                minInput.focus();
                return;
            }
        }
