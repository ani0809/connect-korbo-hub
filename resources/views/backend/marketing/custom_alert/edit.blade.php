                                ...
                                <div class="col-md-8">
                                    @if ($custom_alert->id == 1 || $custom_alert->id == 200)
        						        <textarea name="description" rows="4" 
                                            class="cibato-text-editor form-control" data-buttons='[["font", ["bold"]],["insert", ["link"]]]' required>{{ $custom_alert->description }}</textarea>
                                    @else
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="background_color" value="{{ $custom_alert->background_color }}" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text p-0">
                                                <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ $custom_alert->background_color }}">
                                            </span>
                                        </div>
                                    </div>
                                </div>
