...
<style>
    ...
    .cibato-megabox .cibato-megabox-elem {
    ...
    <div class="card-body border" style="background: #fcfcfc;">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="cibato-megabox mb-3">
                    ...
                    <span class="d-block cibato-megabox-elem rounded-0">
                ...
                <tbody>
                    ...
                    @php
                        if ($custom_alert->id == 200 && !addon_is_activated('club_point')) {
                            continue;
                        }elseif($custom_alert->id == 300 && !addon_is_activated('otp_system')){
                            continue;
                        }
                    @endphp
...
<script type="text/javascript">
    ...
    function update_custom_alert_status() {
        ...
        $.post('{{ route('custom-alerts.update-status') }}', {_token: '{{ csrf_token() }}', id: id, status: status},
            function(data) {
                if(data == 1){
                    CIBATO.plugins.notify('success', '{{ translate('Custom Alert status updated successfully') }}');
                }
            });
    }
