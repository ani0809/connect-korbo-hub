                    ...
                    <div class="row gutters-16">
                        <div class="col-lg-8">
                                    ...
                                    <div class="col-6">
                                        <label class="cibato-megabox d-block bg-white mb-0">
                                            <input
                                                ...
                                                checked
                                            >
                                            <span class="d-flex align-items-center cibato-megabox-elem rounded-0" style="padding: 0.75rem 1.2rem;">
                                                <span class="cibato-rounded-check flex-shrink-0 mt-1"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="background_color" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text p-0">
                                                <input class="cibato-color-picker border-0 size-40px" type="color">
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select name="auto_hide" class="form-control cibato-selectpicker" required>
                                        <option value="" disabled>{{ translate('Select Auto Close Duration') }}</option>
                                        <option value="0">{{ translate('Auto Close Disabled') }}</option>
                                        <option value="3">{{ translate('3 Seconds') }}</option>
                                        <option value="5">{{ translate('5 Seconds') }}</option>
                                        <option value="7">{{ translate('7 Seconds') }}</option>
                                        <option value="9">{{ translate('9 Seconds') }}</option>
                                        <option value="12">{{ translate('12 Seconds') }}</option>
                                    </select>
                                </div>
                            </div>
