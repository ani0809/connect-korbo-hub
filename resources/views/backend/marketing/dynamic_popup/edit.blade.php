                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control cibato-color-input" value="{{ $dynamic_popup->btn_background_color }}" placeholder="#000000" name="btn_background_color" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text p-0">
                                                <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ $dynamic_popup->btn_background_color }}">
                                            </span>
                                        </div>
                                    </div>
                                </div>
