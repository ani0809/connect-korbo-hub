        ...
        <form class="" id="sort_notes" action="" method="GET">
            ...
            <div class="d-sm-flex justify-content-between mx-4">
                <div class="mt-3">
                    ...
                    <a class="btn btn-sm btn-circle fs-12 fw-600 mr-2 {{ in_array($noteUserType, ['store', 'in_house', 'inhouse'], true) ? $activeClasss : $inActiveClasses }}"
                        href="javascript:void(0);" onclick="sort_notes('store')">
                        {{ translate('Products') }}
                    </a>
    ...
    <script type="text/javascript">
        ...
        function updateSellerAccess (el){
            ...
            $.post('{{ route('note.update-seller-access') }}', {
                ...
                if(data == 1){
                    CIBATO.plugins.notify('success', '{{ translate('Admin note seller access status update successfully') }}');
                }
                else{
