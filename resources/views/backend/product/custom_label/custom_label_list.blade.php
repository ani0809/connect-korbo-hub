        ...
        <form class="" id="sort_custom_labels" action="" method="GET">
            ...
            <div class="d-sm-flex justify-content-between mx-4">
                <div class="mt-3">
                    ...
                    <a class="btn btn-sm btn-circle fs-12 fw-600 mr-2 custom-label-filter {{ in_array($customLabelUserType, ['store', 'in_house', 'inhouse'], true) ? $activeClasss : $inActiveClasses }}"
                        data-type="store" href="javascript:void(0);">
                        {{ translate('Products') }}
                    </a>
        ...
        $(document).ready(function() {
            ...
            function update_custom_label_status() {
                ...
                $.post('{{ route('custom-label.update-status') }}', {
                    ...
                    if (data == 1) {
                        CIBATO.plugins.notify('success', '{{ translate('Custom Label seller access updated successfully') }}');
                    } else {
