                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <input type="text" class="form-control cibato-color-input"
                                            name="background_color" value="{{ $custom_label->background_color }}" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text p-0">
                                                <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ $custom_label->background_color }}">
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="products[]" id="products" class="form-control cibato-selectpicker"
