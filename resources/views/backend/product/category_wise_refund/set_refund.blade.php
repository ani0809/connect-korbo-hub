            ...
            <table class="table cibato-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg" width="10%" class="text-center">{{ translate('Products') }}</th>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="form-group mb-0 text-right">
                                <button 
                                    type="button" 
                                    onclick="{{ $isCategoryBasedRefund ? 'trigger_alert(' . $category->id . ')' : 'CIBATO.plugins.notify(\'danger\', \'' . translate('Category based refund is not enabled') . '\')' }}"
    ...
    <script type="text/javascript">
        ...
        $('#confirm-set-btn').on('click', function () {
            ...
            if (!refundTime || refundTime < 1) {
                CIBATO.plugins.notify('danger', '{{ translate('Please enter a valid refund time (1 or more days).') }}');
                return;
            }
