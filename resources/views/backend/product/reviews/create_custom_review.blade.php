                ...
                <form class="form-horizontal" action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="date-selection-div d-none">
                            <input type="text" class="form-control cibato-date-range" name="custom_date" placeholder="{{ translate('Select Date') }}" data-single="true" data-time-picker="true" data-format="Y-MM-DD HH:mm:ss" data-show-dropdown="true" autocomplete="off">
                        </div>
                    </div>
