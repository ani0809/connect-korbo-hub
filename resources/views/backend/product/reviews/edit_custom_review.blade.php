            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('custom-review.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control cibato-selectpicker" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <div class="date-selection-div @if($review->created_at_is_custom == 0) d-none @endif">
                            <input type="text" class="form-control cibato-date-range" name="custom_date" value="{{ $review->created_at }}" placeholder="{{ translate('Select Date') }}" data-single="true" data-time-picker="true" data-format="Y-MM-DD HH:mm:ss" data-show-dropdown="true" autocomplete="off">
                        </div>
                    </div>
