    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-body p-0">
                ...
                <form class="p-4" id="categorySubmitForm" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="select2 form-control cibato-selectpicker" name="parent_id" data-toggle="select2" data-placeholder="Choose ..."data-live-search="true" data-selected="{{ $category->parent_id }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="select2 form-control cibato-selectpicker" name="filtering_attributes[]" data-toggle="select2" data-placeholder="Choose ..."data-live-search="true" data-selected="{{ $category->attributes->pluck('id') }}" multiple>
