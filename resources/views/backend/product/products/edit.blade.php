...
@section('content')
    ...
    <style>
        ...
        .add-product-page-content .input-group .form-control { min-height: 42px; }
        .add-product-page-content h5.fs-16.fw-700 { font-size: 16px !important; line-height: 1.2; color: #1a1d23; }
        ...
        /* Edit Product visual parity polish */
        .add-product-page-content {
        ...
        .cp-title { letter-spacing: -0.02em; }
        .cp-tabs {
            border-radius: 12px;
            padding: 4px 10px 0;
            background: #fff;
        ...
        .cp-tab-link.active { background: #eef4ff; }
        .cp-section-card {
            border-radius: 12px !important;
        ...
        .cp-section-card > .bg-white { padding: 16px !important; }
        .cp-sidebar > div {
            border-color: #d9deea !important;
            border-radius: 12px !important;
        }
    ...
    <div class="page-content">
        <div class="px-3 px-md-2rem add-product-page-content mb-4">
            ...
            <form action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="cibatoSubmitForm">
                @csrf
                ...
                <div class="cp-topbar d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <div class="cp-breadcrumb">{{ translate('Products') }} > {{ translate('Edit Product') }}</div>
                        <div class="cp-title">{{ translate('Edit Product') }}</div>
                    </div>
                    ...
                    <div class="col-xl-8 col-main-editor">
                                ...
                                <div class="row gutters-5">
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="form-group mb-2 mb-lg-3">
                                            ...
                                            <input type="number" lang="en" class="form-control @error('min_qty') is-invalid @enderror" name="min_qty" value="{{ $product->min_qty }}" placeholder="1" min="1" step="1" integer-only>
                                        </div>
                                    </div>
                        ...
                        <div class="border border-gray-300 rounded-2 mt-4" id="product-description">
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4">
                                ...
                                <div class="">
                                    <textarea class="cibato-text-editor" name="description">{{ $product->getTranslation('description', $lang) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-section-card cp-tab-section" data-tab="pricing" id="product-price-stock-section">
                            ...
                            <div class="form-group row gutters-5">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control cibato-selectpicker" data-live-search="true" data-selected-text-format="count" name="colors[]" id="colors" multiple @if(count(json_decode($product->colors)) < 1) disabled @endif>
                            ...
                            <div class="customer_choice_options mb-4" id="customer_choice_options">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control cibato-selectpicker attribute_choice" data-live-search="true" name="choice_options_{{ $choice_option->attribute_id }}[]" data-selected-text-format="count" multiple required>
                        ...
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4">
                            ...
                            <div>
                                ...
                                <div class="form-group mb-0 warranty_selection_div @if($product->has_warranty != 1) d-none @endif">
                                    <select class="form-control cibato-selectpicker mt-2" name="warranty_id" id="warranty_id" @if($product->has_warranty == 1) required @endif>
                            ...
                            <div class="form-group mb-0 mt-3">
                                ...
                                <div class="input-group ">
                                    ...
                                    <div class="input-group-append w-140px">
                                        <select class="form-control cibato-selectpicker" name="tax_type[]">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="fq_bought_select_category_div @if($product->frequently_bought_selection_type != 'category') d-none @endif">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select
                                                        class="form-control cibato-selectpicker"
...
CIBATO.plugins.tagify();
    ...
    function filterFqBoughtProduct() {
        ...
        $.post('{{ route('product.search') }}', { _token: CIBATO.data.csrf, product_id: productID, search_key:searchKey, category:fqBroughCategory, product_type:"physical" }, function(data){
...
<script>
    $(document).ready(function(){
        function activateProductTab(tabKey) {
            ...
            var tabDescriptions = {
                general: '{{ translate("Core product info and classification") }}',
                pricing: '{{ translate("Price, variants and stock behavior") }}',
                shipping: '{{ translate("Shipping setup and delivery notes") }}',
                seo: '{{ translate("SEO metadata and product slug") }}'
            };
