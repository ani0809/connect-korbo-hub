                    ...
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xxl-9 d-flex align-items-center">
                                ...
                                <!-- Light Option -->
                                <label class="cibato-megabox d-block bg-white mb-0 mr-4" style="flex: 1; min-width: 120px;"> 
                                    ...
                                    <span class="d-flex align-items-center cibato-megabox-elem rounded-0"
                                ...
                                <!-- Dark Option -->
                                <label class="cibato-megabox d-block bg-white mb-0" style="flex: 1; min-width: 120px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xxl-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control cibato-color-input" placeholder="Ex: #e1e1e1"
    ...
    <script type="text/javascript">
        ...
        function updateSettings() {
            ...
            $.post('{{ route('business_settings.smart_bar_status') }}', {
                ...
                if (data == 1) {
                    CIBATO.plugins.notify('success', '{{ translate('Settings updated successfully') }}');
                } else {
                    CIBATO.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
            }).fail(function() {
                CIBATO.plugins.notify('danger', '{{ translate('Network error') }}');
            });
        }
