...
@section('content')
    ...
    <style>
        ...
        .add-product-page-content > form > .row {
            margin-left: -10px;
            margin-right: -10px;
        }
        .add-product-page-content > form > .row > [class*="col-"] {
            padding-left: 10px;
            padding-right: 10px;
        }
        .col-main-editor { transition: .2s ease; }
        .col-side-editor { transition: .2s ease; }
        .cp-col-hidden { display: none !important; }
        .cp-col-full { flex: 0 0 100% !important; max-width: 100% !important; }
        .cp-topbar {
            background: #fff; border: 1px solid #e2e4e8; border-radius: 12px; padding: 12px 18px;
            box-shadow: 0 1px 3px rgba(0, 0, 0, .07), 0 1px 2px rgba(0, 0, 0, .04); margin-bottom: 16px;
        }
        .cp-topbar .cp-breadcrumb { font-size: 13px; color: #8d93a4; margin-bottom: 2px; }
        .cp-topbar .cp-title { font-size: 20px; font-weight: 700; color: #1a1d23; line-height: 1.2; }
        .cp-tabs {
            display: flex; align-items: center; background: #f8f9fa; border: 1px solid #e2e4e8;
            border-radius: 12px; padding: 2px 10px 0; margin-bottom: 18px; overflow-x: auto;
        }
        .cp-tab-link {
            display: flex; align-items: center; white-space: nowrap; padding: 12px 14px 10px; margin-right: 2px;
            font-size: 13px; font-weight: 600; color: #5a5f6e; border-bottom: 2px solid transparent;
            text-decoration: none !important; transition: .2s ease;
        }
        .cp-tab-link:hover, .cp-tab-link.active { color: #3b6ef5; border-bottom-color: #3b6ef5; background: #fff; }
        .cp-section-card {
            background: #fff; border: 1px solid #e2e4e8 !important; border-radius: 12px !important;
            box-shadow: 0 1px 3px rgba(0, 0, 0, .07), 0 1px 2px rgba(0, 0, 0, .04);
        }
        .cp-section-card .border-bottom-dashed { border-bottom: 1px dashed #dde0e7 !important; }
        ...
        .add-product-page-content.tab-shipping-grid .col-side-editor {
            flex: 0 0 100% !important;
            max-width: 100% !important;
        }
        .add-product-page-content.tab-shipping-grid .cp-sidebar {
            position: static;
            display: grid;
        ...
        .add-product-page-content.tab-shipping-grid .cp-sidebar > .cp-tab-section[data-tab="shipping"] {
            margin-bottom: 0;
        }
        .cp-topbar .btn { min-height: 40px; font-weight: 600; border-radius: 8px; }
        .cp-section-card > .bg-white,
        .cp-sidebar > div {
            background: #ffffff;
        }
        .add-product-page-content .form-control,
        .add-product-page-content .bootstrap-select .dropdown-toggle {
            min-height: 42px;
            border-radius: 8px !important;
            border-color: #dde1ea !important;
            font-size: 14px;
        }
        .add-product-page-content .input-group .form-control {
            min-height: 42px;
        }
        .add-product-page-content .fs-14 { font-size: 14px !important; }
        .add-product-page-content .fs-16 { font-size: 16px !important; }
        .add-product-page-content h5.fs-16.fw-700 {
            font-size: 16px !important;
            line-height: 1.2;
            color: #1a1d23;
        }
        .cp-section-card > .bg-white { padding-top: 4px; }
        .cp-section-card .form-group { margin-bottom: 14px; }
        .cp-sidebar h5.fs-16.fw-700 { font-size: 16px !important; }
        .cp-sidebar .fs-14 { font-size: 14px !important; }
        .cp-sidebar .form-control,
        .cp-sidebar .bootstrap-select .dropdown-toggle {
            min-height: 42px;
            font-size: 14px;
        }
        @media (min-width: 1200px) {
            .add-product-page-content > form > .row > .col-xl-8 { flex: 0 0 68%; max-width: 68%; }
            .add-product-page-content > form > .row > .col-xl-4 { flex: 0 0 32%; max-width: 32%; }
        }
        @media (max-width: 1199px) { .cp-sidebar { position: static; } }
        @media (max-width: 991px) {
            .add-product-page-content.tab-shipping-grid .cp-sidebar {
                grid-template-columns: 1fr;
            }
        }
        /* Add Product final UX redesign */
        .add-product-page-content {
        ...
        .cp-section-card .border-bottom-dashed {
            border-bottom-style: solid !important;
            border-bottom-color: #e4e8f0 !important;
        }
        .cp-section-card > .bg-white {
            padding: 16px !important;
        }
        ...
        @if($isV2)
        .add-product-v2{background:var(--color-background-tertiary)!important;padding:8px 0 32px!important;max-width:1200px}
        .add-product-v2 .cp-topbar{background:transparent;border:0;box-shadow:none;padding:0;margin-bottom:14px}
        .add-product-v2 .cp-topbar .cp-title{font-size:21px;font-weight:500}
        .add-product-v2 .cp-topbar .cp-breadcrumb{font-size:11px;color:#646970}
        .add-product-v2 .cp-tabs,.add-product-v2 #cp-tab-context,.add-product-v2 .cp-quick-actions-bar{display:none!important}
        .add-product-v2 .mt-4.text-left{display:none!important}
        .add-product-v2 .cp-section-card,.add-product-v2 .cp-sidebar>div{border:1px solid #c3c4c7!important;border-radius:3px!important;box-shadow:none!important;background:#fff}
        .add-product-v2 .cp-section-card .bg-white{padding:13px!important}
        .add-product-v2 .cp-section-card .border-bottom-dashed,.add-product-v2 .cp-sidebar .border-bottom-dashed{border-bottom:1px solid #c3c4c7!important}
        .add-product-v2 .cp-section-card .mb-3.pb-1,.add-product-v2 .cp-sidebar>div>h5{margin:-13px -13px 12px!important;padding:8px 13px!important;background:#f6f7f7;border-bottom:1px solid #c3c4c7!important}
        .add-product-v2 .form-control,.add-product-v2 .bootstrap-select .dropdown-toggle{border:1px solid #c3c4c7!important;border-radius:3px!important;min-height:32px!important}
        .add-product-v2 input[name="name"]{font-size:20px!important;padding:7px 11px!important}
        .add-product-v2 .col-main-editor{flex:0 0 calc(100% - 282px)!important;max-width:calc(100% - 282px)!important}
        .add-product-v2 .col-side-editor{flex:0 0 268px!important;max-width:268px!important}
        @media (max-width: 991px){.add-product-v2 .col-main-editor,.add-product-v2 .col-side-editor{flex:0 0 100%!important;max-width:100%!important}}
        @endif
    </style>

    <div class="page-content">
        <div class="px-3 px-md-2rem add-product-page-content {{ $isV2 ? 'add-product-v2' : '' }} mb-4">
            <!-- Data type -->
            <input type="hidden" id="data_type" value="physical">

            <form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="cibatoSubmitForm">
                @csrf
                <div class="cp-topbar d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <div class="cp-breadcrumb">
                            @if($isV2)
                                {{ translate('Products') }} > {{ translate('Add New') }}
                            @else
                                {{ translate('Products') }} > {{ translate('Add New Product') }}
                            @endif
                        </div>
                        <div class="cp-title">{{ $isV2 ? translate('Add new product') : translate('Add Product') }}</div>
                    </div>
                    <div class="d-flex mt-2 mt-md-0 flex-wrap justify-content-end">
                        @if($isV2)
                        <button type="button" class="btn btn-light mr-2" onclick="document.getElementById('saveDraftBtn').click();">{{ translate('Save Draft') }}</button>
                        @else
                        <a class="btn btn-soft-primary mr-2 mb-2 mb-md-0" href="javascript:void(0);" onclick="clearTempdata()">
                            {{ translate('Clear Tempdata') }}
                        </a>
                        @can('product_duplicate')
                        <a class="btn btn-soft-warning mr-2 mb-2 mb-md-0" href="javascript:void(0);" onclick="showProductSelectModal()">
                            {{ translate('Import Product') }}
                        </a>
                        @endcan
                        <button type="button" class="btn btn-light mr-2" onclick="window.scrollTo({ top: document.body.scrollHeight, behavior: 'smooth' });">{{ translate('Go to Save') }}</button>
                        <button type="button" class="btn btn-primary" onclick="document.querySelector('button[data-action=&quot;publish&quot;]').click();">{{ translate('Save & Publish') }}</button>
                        @endif
                    </div>
                </div>
                <div class="cp-quick-actions-bar">
                    <span class="cp-col-main-title">{{ translate('Quick Actions') }}</span>
                    <button type="button" class="btn btn-light border" onclick="document.querySelector('#basic-information').scrollIntoView({behavior:'smooth', block:'start'});">{{ translate('Go To Basics') }}</button>
                    <button type="button" class="btn btn-light border" onclick="document.querySelector('#product-media').scrollIntoView({behavior:'smooth', block:'start'});">{{ translate('Go To Media') }}</button>
                    <button type="button" class="btn btn-light border" onclick="window.scrollTo({ top: document.body.scrollHeight, behavior: 'smooth' });">{{ translate('Go To Save') }}</button>
                    <button type="button" class="btn btn-secondary" onclick="document.getElementById('saveDraftBtn').click();">{{ translate('Save Draft') }}</button>
                    <button type="button" class="btn btn-success" onclick="document.querySelector('button[data-action=&quot;publish&quot;]').click();">{{ translate('Save & Publish') }}</button>
                </div>

                <div class="cp-tabs">
                    <a href="#basic-information" data-tab="general" class="cp-tab-link active">{{ translate('General') }}</a>
                    <a href="#product-media" data-tab="media" class="cp-tab-link">{{ translate('Media') }}</a>
                    <a href="#product-price-stock-section" data-tab="pricing" class="cp-tab-link">{{ translate('Pricing & Stock') }}</a>
                    <a href="#product-shipping" data-tab="shipping" class="cp-tab-link">{{ translate('Shipping') }}</a>
                    <a href="#product-seo-meta-tag" data-tab="seo" class="cp-tab-link">{{ translate('SEO') }}</a>
                    <a href="#advanced-settings" data-tab="advanced" class="cp-tab-link">{{ translate('Advanced') }}</a>
                </div>
                <div id="cp-tab-context" class="mb-3 text-muted fs-13"></div>

                <div class="row">
                    <div class="col-xl-8 col-main-editor">
                        <!-- Product Basic Information Start -->
                        <div class="border border-gray-300 rounded-2 cp-section-card cp-tab-section" data-tab="general" id="basic-information">
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4">
                                ...
                                <div class="row gutters-5" >
                                    ...
                                    @php
                                        // Recursive closures avoid global function redeclare fatals in compiled Blade.
                                        $renderSingleCategoryOptions = function ($categories, $selectedId = null, $level = 0) use (&$renderSingleCategoryOptions) {
                                        ...
                                        $renderMultiCategoryOptions = function ($categories, $selectedIds = [], $level = 0) use (&$renderMultiCategoryOptions) {
                                            foreach ($categories as $category) {
                                                $indent = str_repeat('&nbsp;&nbsp;&nbsp;', $level);
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-2 mb-lg-3">
                                            ...
                                            <select class="form-control cibato-selectpicker" name="category_id" id="category_id" data-live-search="true">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-2 mb-lg-3">
                                            ...
                                            <select class="form-control cibato-selectpicker" name="brand_id" id="brand_id"
                        ...
                        <div class="border border-gray-300 rounded-2 mt-4 cp-section-card cp-tab-section" data-tab="general" id="product-configuration">
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4" >
                                <div class="mb-3 pb-1 d-flex align-items-center justify-content-between border-bottom-dashed">
                                ...
                                <div class="row gutters-5">
                                    ...
                                    <div class="col-12 d-none">
                                        <div class="form-group mb-2 mb-lg-3">
                                            <select class="form-control cibato-selectpicker" data-live-search="true" name="category_ids[]" id="category_ids" multiple>
                                                @php 
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="form-group mb-2 mb-lg-3">
                                            <label for="unit" class="col-from-label fs-14 fw-500">{{ translate('Unit') }}</label>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="form-group mb-2 mb-lg-3">
                                            <label for="min-qty"
                                                class="col-from-label fs-14 fw-500">{{ translate('Minimum Purchase Qty') }}</label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="tags" class="col-from-label fs-14 fw-500">{{ translate('Tags') }}</label>
                                            <input type="text" class="form-control cibato-tag-input" id="tags"
                        ...
                        <!-- Files & Media Start -->
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-section-card cp-tab-section" data-tab="media" id="product-media">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="col-from-label fs-14 fw-500">
                                            ...
                                            <span class="pb-2 d-block">
                                                <span
                                                    class="fs-12 fw-400 text-gray pr-3">{{ translate('500px X 500px') }}</span>
                                                {{--<a href="#"
                                        ...
                                        <div class="input-group file-upload-input border border-dashed border-gray-400 rounded-1 w-120px h-120px d-flex align-items-center justify-content-center"
                                            data-toggle="cibatouploader" data-type="image">
                                            <div
                                ...
                                <div class="col-md-6 col-lg-7 col-xl-8 mt-3 mt-md-0">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="img-upload-container">
                                            <div class="input-group file-upload-input border border-dashed border-gray-400 rounded-1 w-120px h-120px d-flex align-items-center justify-content-center"
                                                data-toggle="cibatouploader" data-type="image" data-multiple="true">
                                                <div
                                                    class="form-control p-0 border-0 d-flex align-items-center justify-content-center">
                                                    <img src="{{ static_asset('assets/img/plus-lg.svg') }}"
                                                        class="w-40px h-40px w-md-64px h-md-64px" alt="generate Icon">
                                ...
                                <div class="col-md-6 col-lg-5 col-xl-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="mt-2 file-upload-input input-group  border border-dashed border-gray-400 rounded-1 w-120px h-120px d-flex align-items-center justify-content-center"
                                            data-toggle="cibatouploader" data-type="video"  data-multiple="true">
                                            <div
                                                class="form-control p-0 border-0 d-flex align-items-center justify-content-center">
                                                <img src="{{ static_asset('assets/img/plus-lg.svg') }}"
                                                    class="w-40px h-40px w-md-64px h-md-64px" alt="generate Icon">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <div class="input-group" data-toggle="cibatouploader" data-type="document">
                                    <div class="input-group-prepend">
                        ...
                        <div class="border border-gray-300 rounded-2 mt-4 cp-section-card cp-tab-section" data-tab="general" id="product-description">
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4">
                                <div class="mb-3 pb-1 d-flex align-items-center justify-content-between border-bottom-dashed">
                                ...
                                <div class="">
                                    <textarea class="cibato-text-editor" name="description">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- SEO Meta Tags Start -->
                        <div class="border border-gray-300 rounded-2 mt-4 cp-section-card cp-tab-section" data-tab="seo" id="product-seo-meta-tag">
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4">
                                <div class="mb-3 pb-1 d-flex align-items-center justify-content-between border-bottom-dashed">
                                ...
                                <div class="row gutters-5">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-2 mb-lg-3">
                                            ...
                                            <div class="input-group" data-toggle="cibatouploader" data-type="image">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text bg-soft-secondary font-weight-medium">
                                                        {{ translate('Browse') }}</div>
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="meta_keywords" class="col-from-label fs-14 fw-500">{{ translate('Tags') }}</label>
                                            <input type="text" id="meta_keywords" name="meta_keywords[]" class="form-control cibato-tag-input"
                        ...
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-section-card cp-tab-section" data-tab="pricing" id="product-price-stock-section">
                            <div class="mb-3 pb-1 d-flex align-items-center justify-content-between border-bottom-dashed">
                            ...
                            <div class="form-group row gutters-5">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control cibato-selectpicker" data-live-search="true" data-selected-text-format="count" name="colors[]" id="colors" multiple disabled>
                            ...
                            <div class="form-group row gutters-5">
                                ...
                                <div class="col-md-9">
                                    <select name="choice_attributes[]" id="choice_attributes" class="form-control cibato-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ translate('Choose Attributes') }}">
                            ...
                            <div class="row gutters-5 mt-3">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group mb-2 mb-lg-3">
                                        ...
                                        <input type="text" class="form-control cibato-date-range" name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-past-disable="true"  data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2 mb-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control cibato-selectpicker" name="discount_type" id="discount_type">
                        ...
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 mb-4 mb-xl-0 cp-section-card cp-tab-section" data-tab="pricing" id="variant-div-show-hide" style="display: none;">
                    ...
                    <!--Right Side -->
                    <div class="col-xl-4 col-side-editor">
                        <div class="cp-sidebar">

                        <!-- Product Setting Start -->
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 cp-section-card cp-tab-section" data-tab="general" id="advanced-settings">
                            <h5 class="fs-16 fw-700 border-bottom-dashed mb-3 pb-2">{{ translate('Product Settings') }}</h5>
                            <div class="mb-3">
                                <div class="d-flex align-items-center mt-3 mb-2">
                                    <label class="cibato-switch cibato-switch-blue mb-0 pr-2">
                            ...
                            <div class="mt-3">
                                <div class="form-group mb-0">
                                    ...
                                    <select class="form-control cibato-selectpicker mt-2"  name="flash_deal_id" id="flash_deal">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control cibato-selectpicker" name="flash_discount_type" id="flash_discount_type">
                        ...
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-section-card cp-tab-section" data-tab="advanced" id="refund-settings">
                            ...
                            <div>
                                ...
                                <div class="mt-3">
                                    <label class="cibato-checkbox mb-0">
                                        ...
                                        <span class="cibato-square-check" style="width: 20px; height: 20px;"></span>
                                    </label>
                                </div>
                            </div>
                            <div class="mt-4 pt-3 refundable-notes refund-block">
                                <h6 class="fs-14 fw-700 mb-3">{{translate('Note (Add from preset)')}}</h6>
                                <input type="hidden" name="refund_note_id" id="refund_note_id">
                                <div class="cibato-carousel gutters-10" data-items="2" data-xxl-items="2" data-xl-items="2"
                        ...
                        <!-- Club Point Start -->
                        <div class="rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 club-point-container cp-tab-section" data-tab="advanced" id="club-point-settings">
                        ...
                        <!-- Warranty Start -->
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-tab-section" data-tab="advanced" id="warranty-settings">
                            ...
                            <div>
                                ...
                                <div class="form-group mb-0 warranty_selection_div d-none">
                                    <select class="form-control cibato-selectpicker mt-2" name="warranty_id" id="warranty_id">
                        ...
                        <!-- Shipping Start -->
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-section-card cp-tab-section" data-tab="shipping" id="product-shipping">
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    <a href="{{route('shipping_configuration.shipping_method')}}" class="cibato-side-nav-link {{ areActiveRoutes(['shipping_configuration.shipping_method'])}}">
                                        <span class="cibato-side-nav-text">{{translate('Shipping Method')}}</span>
                                    </a>
                                </p>
                                @endif
                            </div>
                        ...
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-tab-section" data-tab="shipping" id="cod-settings">
                            ...
                            <div class="mt-4 pt-3 cash-on-delivery-notes">
                             ...
                             @else
                                <p>
                                    ...
                                    <a href="{{route('activation.index')}}" class="cibato-side-nav-link {{ areActiveRoutes(['shipping_configuration.index','shipping_configuration.edit','shipping_configuration.update'])}}">
                                        <span class="cibato-side-nav-text">{{translate('Cash Payment Activation')}}</span>
                                    </a>
                                </p>
                            @endif
                        </div>
                        ...
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-tab-section" data-tab="pricing" id="gst-tax-settings">
                        ...
                        @if(true)
                        <div class="border border-gray-300 rounded-2 px-3 px-lg-4 py-3 py-lg-4 mt-4 cp-tab-section" data-tab="pricing" id="stock-order-display-settings">
                            ...
                            <div class="mt-3">
                                 <!-- Show Stock Quantity -->
                                <div class="d-flex align-items-center mt-3 mb-2">
                                    <label class="cibato-switch-blue mb-0 pr-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="fq_bought_select_category_div d-none">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control cibato-selectpicker" data-placeholder="{{ translate('Select a Category')}}" name="fq_bought_product_category_id" data-live-search="true" required>
                                                        @foreach ($categories as $category)
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // Keep related category auto-synced with selected main category and move SEO below price-stock.
        $('#product-price-stock-section').after($('#product-seo-meta-tag'));
    });

    $('#cibatoSubmitForm').on('submit', function (e) {
		if ( $('#cibatoSubmitForm .action-btn').attr('attempted') == 'true' ) {
			//stop submitting the form because we have already clicked submit.
			e.preventDefault();
		}
		else {
			$('#cibatoSubmitForm .action-btn').attr("attempted", 'true');
		}
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                <div class="form-group row">\
                    ...
                    <div class="col-md-9">\
                        <select class="form-control cibato-selectpicker attribute_choice" data-live-search="true" name="choice_options_'+ i +'[]" data-selected-text-format="count" multiple required>\
                            '+obj+'\
                        </select>\
                    </div>\
                </div>');
    ...
    function update_sku(){
        $.ajax({
           ...
           data:$('#cibatoSubmitForm').serialize(),
           success: function(data) {
                $('#sku_combination').html(data);
                CIBATO.uploader.previewGenerate();
                CIBATO.plugins.sectionFooTable('#sku_combination');
    ...
    function filterFqBoughtProduct() {
        ...
        $.post('{{ route('product.search') }}', { _token: CIBATO.data.csrf, product_id: null, search_key:searchKey, category:fqBroughCategory, product_type:"physical" }, function(data){
            $('#product-list').html(data);
            CIBATO.plugins.sectionFooTable('#product-list');
        });
    }
    ...
    function addFqBoughtProduct() {
        ...
        $.post('{{ route('get-selected-products') }}', { _token: CIBATO.data.csrf, product_ids:productIds}, function(data){
            $('#fq-bought-product-select-modal').modal('hide');
            $('#selected-fq-bought-products').html(data);
            CIBATO.plugins.sectionFooTable('#selected-fq-bought-products');
        });
    }
...
<script>
    $(document).ready(function(){
        @if($isV2)
        // V2 uses single-page metabox flow.
        $('.cp-tab-section').removeClass('d-none');
        $('.cp-tabs, #cp-tab-context, .cp-quick-actions-bar').addClass('d-none');
        @else
        function activateProductTab(tabKey) {
            var selected = tabKey || 'general';
            var tabDescriptions = {
                general: '{{ translate("Core product info, publish controls and descriptions") }}',
                media: '{{ translate("Thumbnail, gallery, videos and PDF assets") }}',
                pricing: '{{ translate("Pricing, variants, tax and stock behavior") }}',
                shipping: '{{ translate("Delivery rules, shipping notes and COD settings") }}',
                seo: '{{ translate("Search metadata and social preview setup") }}',
                advanced: '{{ translate("Warranty, refund and extra advanced controls") }}'
            };
            $('.cp-tab-link').removeClass('active');
            $('.cp-tab-link[data-tab="' + selected + '"]').addClass('active');

            $('.cp-tab-section').addClass('d-none');
            $('.cp-tab-section[data-tab="' + selected + '"]').removeClass('d-none');
            $('#cp-tab-context').text(tabDescriptions[selected] || '');

            var $mainCol = $('.col-main-editor');
            var $sideCol = $('.col-side-editor');
            var hasMain = $mainCol.find('.cp-tab-section:not(.d-none)').length > 0;
            var hasSide = $sideCol.find('.cp-tab-section:not(.d-none)').length > 0;

            $mainCol.removeClass('cp-col-hidden cp-col-full');
            $sideCol.removeClass('cp-col-hidden cp-col-full');

            if (hasMain && !hasSide) {
                $sideCol.addClass('cp-col-hidden');
                $mainCol.addClass('cp-col-full');
            } else if (!hasMain && hasSide) {
                $mainCol.addClass('cp-col-hidden');
                $sideCol.addClass('cp-col-full');
            }

            var $layoutRoot = $('.add-product-page-content');
            if (selected === 'shipping') {
                $layoutRoot.addClass('tab-shipping-grid');
            } else {
                $layoutRoot.removeClass('tab-shipping-grid');
            }
        }
        ...
        $('.cp-tab-link').on('click', function (e) {
            ...
            activateProductTab(tabKey);
            history.replaceState(null, null, '#tab-' + tabKey);
        });

        var hash = window.location.hash || '';
        if (hash.indexOf('#tab-') === 0 && $('.cp-tab-link[data-tab="' + hash.replace('#tab-', '') + '"]').length) {
            activateProductTab(hash.replace('#tab-', ''));
        } else {
            activateProductTab('general');
        }
        @endif
    });
...
@include('partials.product.product_temp_data')
 ...
 <script type="text/javascript">
    ...
    function filterProductByCategory() {
        ...
        $.post('{{ route('products.search') }}', { _token: CIBATO.data.csrf, product_id: null, search_key:searchKey, category:selectedCategory, product_type:"physical",single_select: 1 }, function(data){
            $('#products-list').html(data);
            CIBATO.plugins.sectionFooTable('#products-list');
        });
    }
   ...
   $(document).ready(function() {
        function saveDraft() {
            ...
            if (draftBtn.length) {
                draftBtn.prop('disabled', true).html('<i class="las la-spinner la-spin mr-2"></i> '+CIBATO.local.saving_as_draft);
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#cibatoSubmitForm').attr('action', "{{ url('admin/products/update') }}/" + draftProductId);

                        if ($('#cibatoSubmitForm input[name="_method"]').length === 0) {
                            $('#cibatoSubmitForm').append('<input type="hidden" name="_method" value="POST">');
                        }

                        if (draftBtn.length) {
                         draftBtn.prop('disabled', false).html('<i class="las la-check-circle mr-2"></i>'+draftBtnText);
                        }
                        CIBATO.plugins.notify('success',  `${response.message}`);
                        savedClearTempdata();
                    } else {
                        if (draftBtn.length) {
                ...
                error: function(xhr) {
                    if (xhr.status === 422) {
                        ...
                        Object.values(errors).forEach(function(fieldErrors) {
                            ...
                            //     CIBATO.plugins.notify('danger', error);
                            // });
                        if (draftBtn.length) {
                            draftBtn.prop('disabled', false).html('<i class="las la-exclamation-circle text-danger mr-2"></i>'+draftBtnText);
                        }
                        ...
                        if (draftBtn.length) {
                         ...
                         //CIBATO.plugins.notify('danger', CIBATO.local.error_occured_while_processing);
                    }
                }
            });
        }

        // Auto-save on custom section tab click
        $('.cp-tab-link').on('click', function() {
 ...
 // AI Generation Function
    function generateWithAI(selectedSections = null) {
        ...
        if (!productName) {
            CIBATO.plugins.notify('warning', '{{ translate("Please enter a product name first") }}');
            return;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    CIBATO.plugins.notify('success', '{{ translate("Product content generated successfully!") }}');
                } else {
                    CIBATO.plugins.notify('danger', response.message || '{{ translate("Failed to generate content") }}');
                }
            },
            error: function(xhr) {
                console.error(xhr);
                ...
                CIBATO.plugins.notify('danger', errorMessage);
            },
            complete: function() {
    ...
    function fillGeneratedData(data) {
       // console.log('AI Generated Data:', data);
        ...
        $.each(data, function(fieldName, fieldValue) {
            ...
            // for tagify
            if ($field.hasClass('cibato-tag-input') || fieldName.includes('tag') || fieldName === 'meta_keywords') {
