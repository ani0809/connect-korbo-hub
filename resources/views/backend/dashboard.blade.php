                ...
                <div class="row gutters-16">
                    ...
                    <div class="col-sm-6">
                        <div class="dashboard-box bg-white mb-2rem overflow-hidden" style="height: 470px;">
                            ...
                            @else
                                <div class="px-0 mb-0 h-100 d-flex flex-column justify-content-between">
                                    <div class="mb-2 px-2rem">
                                        <h2 class="fs-16 fw-600 text-primary mb-1 h-40px">{{ translate('Top Category') }}</h2>
                                    ...
                                    <ul class="nav nav-tabs dashboard-tab dashboard-tab-primary border-0 px-2rem mb-3" role="tablist"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active dash_top_categories" id="all-tab" href="#all"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link dash_top_categories" id="today-tab" href="#today" data-toggle="tab"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link dash_top_categories" id="week-tab" href="#week" data-toggle="tab"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link dash_top_categories" id="month-tab" href="#month" data-toggle="tab"
                                    ...
                                    <div class="h-100 c-scrollbar-light px-2rem mt-4"
                                        style="overflow-x: hidden;" id="dash-top-categories">
                                    </div>
                                </div>
                            @endif
                        </div>
                ...
                <div class="row gutters-16">
                    ...
                    <div class="col-sm-12">
                        <div class="dashboard-box px-0 mb-2rem overflow-hidden" style="height: 474px;">
                            <div class="mb-2 px-2rem">
                                <h2 class="fs-16 fw-600 text-primary mb-1 h-40px">{{ translate('Top Category') }}
                                </h2>
                                <h4 class="fs-13 fw-600 text-secondary mb-0">{{ translate('By Sales') }}</h4>
                            </div>
                            <!-- nav -->
                            <ul class="nav nav-tabs dashboard-tab dashboard-tab-primary border-0 px-2rem mb-3" role="tablist"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link dash_top_categories" id="today-tab" href="#today"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link dash_top_categories" id="week-tab" href="#week"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link dash_top_categories" id="month-tab" href="#month"
                ...
                <div class="dashboard-box bg-white mb-2rem overflow-hidden">
                    <div class="row gutters-16">
                        ...
                        <div class="col-sm-6 d-flex flex-column justify-content-between">
                            <!-- Total store revenue -->
                            <div>
                                <h2 class="fs-16 fw-600 text-dark mb-2rem">{{ translate('Store') }}</h2>
                                <h1 class="fs-30 fw-600 text-dark mb-1">
                                    {{ single_price($total_store_sale) }}
                                </h1>
                            ...
                            <a href="{{ route('store_orders.index') }}"
                                class="btn btn-md btn-soft-info btn-block rounded-2 mt-4 mb-4 mt-sm-0 mb-sm-0">{{ translate('Store Orders') }}</a>
                        </div>

                        <div class="col-sm-6">
                            <!-- Product count (admin store) -->
                            <div
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        CIBATO.plugins.chart('#graph-2', {
            type: 'doughnut',
            data: {
                labels: [
                    @foreach ($payment_type_wise_store_sale as $row)
