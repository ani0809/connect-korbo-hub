            ...
            <form class="form-horizontal" action="{{ route('addons.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="domain_purchase_code">{{ translate('Main license code')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="domain_purchase_code" name="domain_purchase_code" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="purchase_code">{{ translate('Addon license code')}}</label>
                        <div class="col-sm-9">
