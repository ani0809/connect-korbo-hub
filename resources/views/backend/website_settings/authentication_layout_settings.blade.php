			...
			<div class="row">
				...
				<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
					<label class="cibato-megabox d-block mb-3">
						...
						<span class="d-block cibato-megabox-elem rounded-0 img-overlay">
...
<div class="cibato-titlebar border-bottom border-gray mb-3 mt-2 mt-md-5 pb-2 text-left">
	<div class="row align-items-center">
		<div class="col">
...
@section('script')
	<script>
		function imageShowOverlay(img){
			...
			$('.cibato-main-wrapper').css('height', '100vh');
			$('.cibato-main-wrapper').css('overflow-y', 'hidden');
		}
		...
		function imageHideOverlay(){
			...
			$('.cibato-main-wrapper').css('height', '100%');
			$('.cibato-main-wrapper').css('overflow-y', 'auto');
		}
	</script>
@endsection
