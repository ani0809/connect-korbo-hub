...
@section('content')
	<div class="page-content">
		<div class="cibato-titlebar text-left mt-2 pb-2 px-3 px-md-2rem border-bottom border-gray">
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="flash_deal_bg_color" value="{{ get_setting('flash_deal_bg_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('flash_deal_bg_color') }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group d-inline-block mb-1">
												<label class="cibato-checkbox">
													...
													<span class="cibato-square-check"></span>
												</label>
											</div>
											<!-- Outline color -->
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="flash_deal_section_outline_color" value="{{ get_setting('flash_deal_section_outline_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('flash_deal_section_outline_color') }}">
														</span>
													</div>
												</div>
											</div>
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="featured_section_bg_color" value="{{ get_setting('featured_section_bg_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('featured_section_bg_color') }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="featured_section_outline_color" value="{{ get_setting('featured_section_outline_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('featured_section_outline_color') }}">
														</span>
													</div>
												</div>
											</div>
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="best_selling_section_bg_color" value="{{ get_setting('best_selling_section_bg_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('best_selling_section_bg_color') }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="best_selling_section_outline_color" value="{{ get_setting('best_selling_section_outline_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('best_selling_section_outline_color') }}">
														</span>
													</div>
												</div>
											</div>
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="new_products_section_bg_color" value="{{ get_setting('new_products_section_bg_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('new_products_section_bg_color') }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="new_products_section_outline_color" value="{{ get_setting('new_products_section_outline_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('new_products_section_outline_color') }}">
														</span>
													</div>
												</div>
											</div>
                                        ...
                                        <div class="p-4 border mb-4" style="background: #fcfcfc;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="auction_section_bg_color" value="{{ get_setting('auction_section_bg_color') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text p-0">
                                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('auction_section_bg_color') }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="auction_content_bg_color" value="{{ get_setting('auction_content_bg_color') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text p-0">
                                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('auction_content_bg_color') }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="auction_section_outline_color" value="{{ get_setting('auction_section_outline_color') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text p-0">
                                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('auction_section_outline_color') }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="cupon_background_color" value="{{ get_setting('cupon_background_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('cupon_background_color') }}">
														</span>
													</div>
												</div>
											</div>
                                        ...
                                        <div class="p-4 border mb-4" style="background: #fcfcfc;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="home_categories_section_bg_color" value="{{ get_setting('home_categories_section_bg_color') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text p-0">
                                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('home_categories_section_bg_color') }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="home_categories_content_bg_color" value="{{ get_setting('home_categories_content_bg_color') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text p-0">
                                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('home_categories_content_bg_color') }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="home_categories_content_outline_color" value="{{ get_setting('home_categories_content_outline_color') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text p-0">
                                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('home_categories_content_outline_color') }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
													...
													<div class="row gutters-5">
														<div class="col">
															<div class="form-group mb-0">
																<select class="form-control cibato-selectpicker" name="home_categories[]" data-live-search="true" data-selected={{ $value }} required>
										...
										<button
											...
											<div class="p-4 mb-3 mb-md-2rem remove-parent" style="border: 1px dashed #e4e5eb;">
												<div class="row gutters-5">
													<div class="col">
														<div class="form-group mb-0">
															<select class="form-control cibato-selectpicker" name="home_categories[]" data-live-search="true" required>
                                        ...
                                        <div class="p-4 border mb-4" style="background: #fcfcfc;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="classified_section_bg_color" value="{{ get_setting('classified_section_bg_color') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text p-0">
                                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('classified_section_bg_color') }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control cibato-color-input" placeholder="#000000" name="classified_section_outline_color" value="{{ get_setting('classified_section_outline_color') }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text p-0">
                                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('classified_section_outline_color') }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="sellers_section_bg_color" value="{{ get_setting('sellers_section_bg_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('sellers_section_bg_color') }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="sellers_section_outline_color" value="{{ get_setting('sellers_section_outline_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('sellers_section_outline_color') }}">
														</span>
													</div>
												</div>
											</div>
							...
							<div class="bg-white p-3 p-sm-2rem">
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="brands_section_bg_color" value="{{ get_setting('brands_section_bg_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('brands_section_bg_color') }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control cibato-color-input" placeholder="#000000" name="brands_section_outline_color" value="{{ get_setting('brands_section_outline_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('brands_section_outline_color') }}">
														</span>
													</div>
												</div>
											</div>
								...
								<div class="w-100">
									...
									<div class="form-group">
										...
										<select name="top_brands[]" class="form-control cibato-selectpicker" multiple data-max-options="12" data-live-search="true" data-selected="{{ get_setting('top_brands') }}">
