                ...
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select name="timezone" class="form-control cibato-selectpicker" data-live-search="true">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select name="uploaded_image_format" class="form-control cibato-selectpicker" data-live-search="true" data-selected="{{ get_setting('uploaded_image_format') }}">
                ...
                <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <select name="image_watermark_type" class="form-control cibato-selectpicker">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control cibato-color-input" placeholder="Ex: #e1e1e1" name="watermark_text_color" value="{{ get_setting('watermark_text_color') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text p-0">
                                            <input class="cibato-color-picker border-0 size-40px" type="color" value="{{ get_setting('watermark_text_color') }}">
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <select name="watermark_position" class="form-control cibato-selectpicker" data-selected="{{ get_setting('watermark_position') }}">
